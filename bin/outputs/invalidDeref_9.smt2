...
(assert
 (let (($x2116 (= loc_9 7)))
 (let (($x2113 (= invalidDeref_8 invalidDeref_9)))
 ...
 (let (($x2111 (and (and (and (or true invalidDeref_8) (and true true)) $x2097) $x2110)))
 (let (($x2026 (= loc_8 7)))
 (let (($x2022 (= invalidDeref_7 invalidDeref_8)))
 ...
 (let (($x2020 (and (and (and (or (= $r_main01_8 0) invalidDeref_7) $x1942) $x2009) $x2019)))
 (let (($x1933 (= loc_7 6)))
 ...
 (let (($x1854 (= invalidDeref_7 invalidDeref12_7)))
 (let (($x1851 (= H_7 H11_7)))
 ...
 (let (($x1797 (= invalidDeref12_7 invalidDeref11_7)))
 (let (($x1798 (and invalidDeref11_7 $x1797)))
 ...
 (let (($x1808 (= $p11_free_data01_7 nil)))
 (let (($x1812 (= h26 (uplus H10_7 (pt $p11_free_data01_7 (Pt_R_0 l34_7))))))
 (let (($x1816 (or (or (and (or $x1812 $x1808) invalidDeref12_7) (and $x1806 $x1797)) $x1798)))
 (let (($x1818 (= $p11_free_data01_7 (locadd $p0_free_data0_6 1))))
 (let (($x1820 (= invalidDeref11_7 invalidDeref_6)))
 (let (($x1821 (and invalidDeref_6 $x1820)))
 ...
 (let (($x1831 (= $p10_free_data01_7 nil)))
 (let (($x1835 (= h24 (uplus H_6 (pt $p10_free_data01_7 (Pt_R_0 l32_7))))))
 (let (($x1839 (or (or (and (or $x1835 $x1831) invalidDeref11_7) (and $x1829 $x1820)) $x1821)))
 (let (($x1842 (and (or (= $p10_free_data01_7 $p0_free_data0_6) invalidDeref_6) $x1839)))
 (let (($x1856 (and (and (and $x1842 (or $x1818 invalidDeref11_7)) $x1816) (and $x1852 $x1854))))
 (let (($x1766 (= loc_6 9)))
 (let (($x1762 (= invalidDeref_5 invalidDeref_6)))
 ...
 (let (($x1778 (and (and (or (not (= $i7_free_data0_5 1)) invalidDeref_5) $x1771) $x1777)))
 (let (($x1550 (= loc_5 8)))
 ...
 (let (($x1760 (and (and (and (and $x1672 (or $x1621 invalidDeref_5)) $x1685) $x1746) $x1759)))
 (let (($x1783 (and (=> $x1550 (and (and $x1760 $x1762) $x1766)) (=> $x1550 (and (and (and $x1778 $x1759) $x1762) $x1766)))))
 ...
 (let (($x1487 (= invalidDeref_5 invalidDeref10_5)))
 ...
 (let (($x1383 (= invalidDeref10_5 invalidDeref9_5)))
 (let (($x1384 (and invalidDeref9_5 $x1383)))
 (let (($x1385 (= $i6_free_data01_5 d9_5)))
 (let (($x1389 (= H_4 (uplus h19_5 (pt $p4_free_data01_5 (Pt_R_1 d9_5))))))
 (let (($x1390 (and $x1389 $x1385)))
 (let (($x1392 (= $p4_free_data01_5 nil)))
 (let (($x1396 (= h20_5 (uplus H_4 (pt $p4_free_data01_5 (Pt_R_1 d10_5))))))
 (let (($x1400 (or (or (and (or $x1396 $x1392) invalidDeref10_5) (and $x1390 $x1383)) $x1384)))
 (let (($x1401 (= invalidDeref9_5 invalidDeref8_5)))
 (let (($x1402 (and invalidDeref8_5 $x1401)))
 (let (($x1403 (= $i5_free_data01_5 d7_5)))
 (let (($x1407 (= H_4 (uplus h17_5 (pt $p2_free_data01_5 (Pt_R_1 d7_5))))))
 (let (($x1408 (and $x1407 $x1403)))
 (let (($x1410 (= $p2_free_data01_5 nil)))
 (let (($x1414 (= h18_5 (uplus H_4 (pt $p2_free_data01_5 (Pt_R_1 d8_5))))))
 (let (($x1419 (= invalidDeref8_5 invalidDeref7_5)))
 (let (($x1420 (and invalidDeref7_5 $x1419)))
 (let (($x1421 (= $p4_free_data01_5 l13_5)))
 (let (($x1425 (= H_4 (uplus h15_5 (pt $p3_free_data01_5 (Pt_R_0 l13_5))))))
 (let (($x1426 (and $x1425 $x1421)))
 (let (($x1428 (= $p3_free_data01_5 nil)))
 (let (($x1432 (= h16_5 (uplus H_4 (pt $p3_free_data01_5 (Pt_R_0 l14_5))))))
 (let (($x1438 (= $p3_free_data01_5 (locadd $p0_free_data0_4 1))))
 (let (($x1440 (= invalidDeref7_5 invalidDeref_4)))
 (let (($x1441 (and invalidDeref_4 $x1440)))
 (let (($x1442 (= $p2_free_data01_5 l11_5)))
 (let (($x1446 (= H_4 (uplus h13_5 (pt $p1_free_data01_5 (Pt_R_0 l11_5))))))
 (let (($x1447 (and $x1446 $x1442)))
 (let (($x1449 (= $p1_free_data01_5 nil)))
 (let (($x1453 (= h14_5 (uplus H_4 (pt $p1_free_data01_5 (Pt_R_0 l12_5))))))
 (let (($x1460 (and (or (= $p1_free_data01_5 $p0_free_data0_4) invalidDeref_4) (or (or (and (or $x1453 $x1449) invalidDeref7_5) (and $x1447 $x1440)) $x1441))))
 (let (($x1462 (and (and $x1460 (or $x1438 invalidDeref7_5)) (or (or (and (or $x1432 $x1428) invalidDeref8_5) (and $x1426 $x1419)) $x1420))))
 (let (($x1463 (and $x1462 (or (or (and (or $x1414 $x1410) invalidDeref9_5) (and $x1408 $x1401)) $x1402))))
 (let (($x1489 (and (and (and $x1463 $x1400) (or $x1381 invalidDeref10_5)) (and $x1485 $x1487))))
 (let (($x1343 (= loc_4 4)))
 (let (($x1340 (= invalidDeref_3 invalidDeref_4)))
 ...
 (let (($x1325 (and (and (or (= $p0_free_data01_4 $p0_main0_3) invalidDeref_3) $x1260) $x1324)))
 (let (($x1251 (= loc_3 3)))
 ...
 (let (($x1197 (= invalidDeref_3 invalidDeref6_3)))
 (let (($x1194 (= H_3 H6_3)))
 ...
 (let (($x995 (= invalidDeref6_3 invalidDeref5_3)))
 (let (($x996 (and invalidDeref5_3 $x995)))
 ...
 (let (($x1006 (= $p10_alloc_data01_3 nil)))
 (let (($x1010 (= h12 (uplus H5_3 (pt $p10_alloc_data01_3 (Pt_R_1 d6_3))))))
 (let (($x1015 (= invalidDeref5_3 invalidDeref4_3)))
 (let (($x1016 (and invalidDeref4_3 $x1015)))
 (let (($x1017 (= $p10_alloc_data01_3 l9_3)))
 (let (($x1021 (= H5_3 (uplus h9_3 (pt $p9_alloc_data01_3 (Pt_R_0 l9_3))))))
 (let (($x1022 (and $x1021 $x1017)))
 (let (($x1024 (= $p9_alloc_data01_3 nil)))
 (let (($x1028 (= h10_3 (uplus H5_3 (pt $p9_alloc_data01_3 (Pt_R_0 l10_3))))))
 (let ((?x1033 (locadd $p0_alloc_data0_2 1)))
 (let (($x1034 (= $p9_alloc_data01_3 ?x1033)))
 (let (($x1036 (= invalidDeref4_3 invalidDeref3_3)))
 (let (($x1037 (and invalidDeref3_3 $x1036)))
 ...
 (let (($x1047 (= $p8_alloc_data01_3 nil)))
 (let (($x1051 (= h8 (uplus H4_3 (pt $p8_alloc_data01_3 (Pt_R_1 d4_3))))))
 (let (($x1056 (= invalidDeref3_3 invalidDeref2_3)))
 (let (($x1057 (and invalidDeref2_3 $x1056)))
 (let (($x1058 (= $p8_alloc_data01_3 l7_3)))
 (let (($x1062 (= H4_3 (uplus h5_3 (pt $p7_alloc_data01_3 (Pt_R_0 l7_3))))))
 (let (($x1063 (and $x1062 $x1058)))
 (let (($x1065 (= $p7_alloc_data01_3 nil)))
 (let (($x1069 (= h6_3 (uplus H4_3 (pt $p7_alloc_data01_3 (Pt_R_0 l8_3))))))
 (let (($x1076 (= invalidDeref2_3 invalidDeref1_3)))
 (let (($x1077 (and invalidDeref1_3 $x1076)))
 ...
 (let (($x1088 (= $p6_alloc_data01_3 nil)))
 (let (($x1092 (= h4 (uplus H3_3 (pt $p6_alloc_data01_3 (Pt_R_0 l6_3))))))
 ...
 (let (($x1112 (= invalidDeref1_3 invalidDeref_2)))
 (let (($x1113 (and invalidDeref_2 $x1112)))
 ...
 (let (($x1124 (= $p3_alloc_data01_3 nil)))
 (let (($x1128 (= h2 (uplus H1_3 (pt $p3_alloc_data01_3 (Pt_R_0 l3_3))))))
 ...
 (let (($x1148 (and (or $x1146 invalidDeref_2) (or (= $p2_alloc_data01_3 $p1_alloc_data01_3) invalidDeref_2))))
 (let (($x1149 (and $x1148 (or (= $p3_alloc_data01_3 $p0_alloc_data0_2) invalidDeref_2))))
 (let (($x1150 (and $x1149 (or (or (and (or $x1128 $x1124) invalidDeref1_3) (and $x1122 $x1112)) $x1113))))
 (let (($x1152 (and (and $x1150 (or $x1110 invalidDeref1_3)) (or (= $p5_alloc_data01_3 $p4_alloc_data01_3) invalidDeref1_3))))
 (let (($x1154 (and (and $x1152 (or (= $p6_alloc_data01_3 ?x1033) invalidDeref1_3)) (or (or (and (or $x1092 $x1088) invalidDeref2_3) (and $x1086 $x1076)) $x1077))))
 (let (($x1155 (and $x1154 (or (= $p7_alloc_data01_3 $p0_alloc_data0_2) invalidDeref2_3))))
 (let (($x1156 (and $x1155 (or (or (and (or $x1069 $x1065) invalidDeref3_3) (and $x1063 $x1056)) $x1057))))
 (let (($x1157 (and $x1156 (or (or (and (or $x1051 $x1047) invalidDeref4_3) (and $x1045 $x1036)) $x1037))))
 (let (($x1159 (and (and $x1157 (or $x1034 invalidDeref4_3)) (or (or (and (or $x1028 $x1024) invalidDeref5_3) (and $x1022 $x1015)) $x1016))))
 (let (($x1160 (and $x1159 (or (or (and (or $x1010 $x1006) invalidDeref6_3) (and $x1004 $x995)) $x996))))
 (let (($x941 (= loc_2 2)))
 (let (($x1253 (=> $x941 (and (and (and (and $x1160 (and $x1195 $x1197)) $x1235) $x1248) $x1251))))
 ...
 (let (($x923 (and (and (or (= $p0_alloc_data01_2 $p0_main0_1) invalidDeref_1) $x858) $x922)))
 (let (($x849 (= loc_1 1)))
 (let (($x846 (= invalidDeref_0 invalidDeref_1)))
 ...
 (let (($x852 (and (and $x703 $x705) (=> $x701 (and (and (and (and $x742 $x826) $x843) $x846) $x849)))))
 (let (($x1254 (and (and $x852 (=> $x849 (and (and (and $x923 $x935) $x938) $x941))) $x1253)))
 (let (($x1553 (and (and $x1254 (=> $x1251 (and (and (and $x1325 $x1337) $x1340) $x1343))) (=> $x1343 (and (and (and $x1489 $x1543) $x1547) $x1550)))))
 (let (($x1936 (and (and $x1553 $x1783) (=> $x1766 (and (and (and $x1856 $x1916) $x1929) $x1933)))))
 (let (($x2119 (and (and $x1936 (=> $x1933 (and (and $x2020 $x2022) $x2026))) (=> $x2026 (and (and $x2111 $x2113) $x2116)))))
 (and $x2119 invalidDeref_9))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
