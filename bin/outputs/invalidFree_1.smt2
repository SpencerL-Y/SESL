...
(assert
 ...
 (let (($x454 (= invalidFree_1 invalidFree1_1)))
 (let (($x396 (= H_1 H3_1)))
 (let (($x393 (= AH_1 AH3_1)))
 ...
 (let (($x430 (or $x313 invalidFree1_1)))
 ...
 (let (($x432 (= invalidFree1_1 invalidFree_0)))
 (let (($x433 (and invalidFree_0 $x432)))
 (let (($x326 (= H2_1 h1_1)))
 ...
 (let (($x440 (or (= $p2_main01_1 nil) (= ah2_1 (uplus AH1_1 (pt $p2_main01_1 (Pt_R_1 d3_1)))))))
 (let (($x441 (and $x440 invalidFree1_1)))
 (let (($x354 (= $p2_main01_1 $p1_main01_1)))
 (let (($x444 (or $x354 invalidFree_0)))
 (let (($x356 (= $p1_main01_1 $p0_main01_1)))
 (let (($x445 (or $x356 invalidFree_0)))
 ...
 (let (($x449 (and (and (and (or $x367 invalidFree_0) $x445) $x444) (or (or $x441 (and $x352 $x432)) $x433))))
 (let (($x452 (and (and (and $x449 (or $x324 invalidFree1_1)) $x430) (or $x311 invalidFree1_1))))
 (let (($x277 (= loc_0 1)))
 (let (($x460 (=> $x277 (and (and (and (and $x452 (and $x397 $x454)) $x407) $x412) $x418))))
 (let (($x424 (not invalidFree_0)))
 (let (($x279 (and (and (= H_0 emp) (= AH_0 emp)) $x277)))
 (and (and (and $x279 $x424) $x460) invalidFree_1)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
