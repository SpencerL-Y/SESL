...
(assert
 (let (($x2116 (= loc_9 7)))
 (let (($x2299 (= invalidFree_8 invalidFree_9)))
 ...
 (let (($x2297 (and (and (and (or true invalidFree_8) (and true true)) $x2097) $x2110)))
 (let (($x2026 (= loc_8 7)))
 (let (($x2289 (= invalidFree_7 invalidFree_8)))
 ...
 (let (($x2284 (or $x1938 invalidFree_7)))
 (let (($x1933 (= loc_7 6)))
 (let (($x2292 (=> $x1933 (and (and (and (and (and $x2284 $x1942) $x2009) $x2019) $x2289) $x2026))))
 (let (($x2279 (= invalidFree_6 invalidFree_7)))
 ...
 (let (($x1806 (and (= H10_7 (uplus h25_7 (pt $p11_free_data01_7 (Pt_R_0 l33_7)))) (= H11_7 (uplus h25_7 (pt $p11_free_data01_7 (Pt_R_0 nil)))))))
 (let (($x2267 (or $x1806 invalidFree_6)))
 (let (($x1818 (= $p11_free_data01_7 (locadd $p0_free_data0_6 1))))
 (let (($x2268 (or $x1818 invalidFree_6)))
 (let (($x1829 (and (= H_6 (uplus h23_7 (pt $p10_free_data01_7 (Pt_R_0 l31_7)))) (= H10_7 (uplus h23_7 (pt $p10_free_data01_7 (Pt_R_0 nil)))))))
 (let (($x2269 (or $x1829 invalidFree_6)))
 (let (($x1840 (= $p10_free_data01_7 $p0_free_data0_6)))
 (let (($x2270 (or $x1840 invalidFree_6)))
 (let (($x2277 (and (and (and (and (and (and $x2270 $x2269) $x2268) $x2267) $x2274) $x1916) $x1929)))
 (let (($x1766 (= loc_6 9)))
 (let (($x2261 (= invalidFree_5 invalidFree_6)))
 ...
 (let (($x1769 (not $x1668)))
 (let (($x2257 (or $x1769 invalidFree_5)))
 (let (($x1550 (= loc_5 8)))
 (let (($x2264 (=> $x1550 (and (and (and (and (and $x2257 $x1771) $x1777) $x1759) $x2261) $x1766))))
 (let (($x1746 (and $x1743 $x1745)))
 (let (($x2250 (= invalidFree_6 invalidFree2_6)))
 (let (($x1683 (= H_6 H9_6)))
 ...
 (let (($x2222 (= invalidFree2_6 invalidFree1_6)))
 (let (($x2223 (and invalidFree1_6 $x2222)))
 ...
 (let (($x2229 (and (= ah4_6 (uplus AH4_6 (pt $p9_free_data01_6 (Pt_R_1 d18_6)))) invalidFree2_6)))
 (let (($x1623 (= $p9_free_data01_6 $p4_free_data0_5)))
 (let (($x2232 (or $x1623 invalidFree1_6)))
 (let (($x2233 (= invalidFree1_6 invalidFree_5)))
 (let (($x2234 (and invalidFree_5 $x2233)))
 ...
 (let (($x2240 (and (= ah2_6 (uplus AH_5 (pt $p8_free_data01_6 (Pt_R_1 d14_6)))) invalidFree1_6)))
 (let (($x1666 (= $p8_free_data01_6 $p2_free_data0_5)))
 (let (($x2243 (or $x1666 invalidFree_5)))
 (let (($x2244 (or $x1668 invalidFree_5)))
 (let (($x2247 (and (and (and $x2244 $x2243) (or (or $x2240 (and $x1664 $x2233)) $x2234)) $x2232)))
 (let (($x2252 (and (and $x2247 (or (or $x2229 (and $x1621 $x2222)) $x2223)) (and $x1684 $x2250))))
 (let (($x2211 (= invalidFree_4 invalidFree_5)))
 ...
 (let (($x1390 (and (= H_4 (uplus h19_5 (pt $p4_free_data01_5 (Pt_R_1 d9_5)))) (= $i6_free_data01_5 d9_5))))
 (let (($x2194 (or $x1390 invalidFree_4)))
 (let (($x1408 (and (= H_4 (uplus h17_5 (pt $p2_free_data01_5 (Pt_R_1 d7_5)))) (= $i5_free_data01_5 d7_5))))
 (let (($x2195 (or $x1408 invalidFree_4)))
 (let (($x1426 (and (= H_4 (uplus h15_5 (pt $p3_free_data01_5 (Pt_R_0 l13_5)))) (= $p4_free_data01_5 l13_5))))
 (let (($x2196 (or $x1426 invalidFree_4)))
 (let (($x1438 (= $p3_free_data01_5 (locadd $p0_free_data0_4 1))))
 (let (($x2197 (or $x1438 invalidFree_4)))
 (let (($x1447 (and (= H_4 (uplus h13_5 (pt $p1_free_data01_5 (Pt_R_0 l11_5)))) (= $p2_free_data01_5 l11_5))))
 (let (($x2198 (or $x1447 invalidFree_4)))
 (let (($x1458 (= $p1_free_data01_5 $p0_free_data0_4)))
 (let (($x2199 (or $x1458 invalidFree_4)))
 (let (($x2205 (and (and (and (and (and (and $x2199 $x2198) $x2197) $x2196) $x2195) $x2194) (or $x1381 invalidFree_4))))
 (let (($x1343 (= loc_4 4)))
 (let (($x2214 (=> $x1343 (and (and (and (and (and $x2205 $x2206) $x1543) $x1547) $x2211) $x1550))))
 (let (($x2188 (= invalidFree_3 invalidFree_4)))
 ...
 (let (($x2183 (or $x1256 invalidFree_3)))
 (let (($x1251 (= loc_3 3)))
 (let (($x2191 (=> $x1251 (and (and (and (and (and $x2183 $x1260) $x1324) $x1337) $x2188) $x1343))))
 (let (($x2178 (= invalidFree_2 invalidFree_3)))
 ...
 (let (($x1004 (and (= H5_3 (uplus h11_3 (pt $p10_alloc_data01_3 (Pt_R_1 d5_3)))) (= H6_3 (uplus h11_3 (pt $p10_alloc_data01_3 (Pt_R_1 8)))))))
 (let (($x2146 (or $x1004 invalidFree_2)))
 (let (($x1022 (and (= H5_3 (uplus h9_3 (pt $p9_alloc_data01_3 (Pt_R_0 l9_3)))) (= $p10_alloc_data01_3 l9_3))))
 (let (($x2147 (or $x1022 invalidFree_2)))
 (let ((?x1033 (locadd $p0_alloc_data0_2 1)))
 (let (($x1034 (= $p9_alloc_data01_3 ?x1033)))
 (let (($x2148 (or $x1034 invalidFree_2)))
 (let (($x1045 (and (= H4_3 (uplus h7_3 (pt $p8_alloc_data01_3 (Pt_R_1 d3_3)))) (= H5_3 (uplus h7_3 (pt $p8_alloc_data01_3 (Pt_R_1 4)))))))
 (let (($x2149 (or $x1045 invalidFree_2)))
 (let (($x1063 (and (= H4_3 (uplus h5_3 (pt $p7_alloc_data01_3 (Pt_R_0 l7_3)))) (= $p8_alloc_data01_3 l7_3))))
 (let (($x2150 (or $x1063 invalidFree_2)))
 (let (($x1074 (= $p7_alloc_data01_3 $p0_alloc_data0_2)))
 (let (($x2151 (or $x1074 invalidFree_2)))
 (let (($x1081 (= H4_3 (uplus h3_3 (pt $p6_alloc_data01_3 (Pt_R_0 $p4_alloc_data01_3))))))
 (let (($x1086 (and (= H3_3 (uplus h3_3 (pt $p6_alloc_data01_3 (Pt_R_0 l5_3)))) $x1081)))
 (let (($x2152 (or $x1086 invalidFree_2)))
 (let (($x1097 (= $p6_alloc_data01_3 ?x1033)))
 (let (($x2153 (or $x1097 invalidFree_2)))
 (let (($x1099 (= $p5_alloc_data01_3 $p4_alloc_data01_3)))
 (let (($x2154 (or $x1099 invalidFree_2)))
 ...
 (let (($x1122 (and (= H1_3 (uplus h1_3 (pt $p3_alloc_data01_3 (Pt_R_0 l2_3)))) $x1117)))
 (let (($x2156 (or $x1122 invalidFree_2)))
 (let (($x1133 (= $p3_alloc_data01_3 $p0_alloc_data0_2)))
 (let (($x2157 (or $x1133 invalidFree_2)))
 (let (($x1135 (= $p2_alloc_data01_3 $p1_alloc_data01_3)))
 (let (($x2158 (or $x1135 invalidFree_2)))
 ...
 (let (($x2163 (and (and (and (and (or $x1146 invalidFree_2) $x2158) $x2157) $x2156) (or $x1110 invalidFree_2))))
 (let (($x2169 (and (and (and (and (and (and $x2163 $x2154) $x2153) $x2152) $x2151) $x2150) $x2149)))
 (let (($x2176 (and (and (and (and (and (and $x2169 $x2148) $x2147) $x2146) $x2173) $x1235) $x1248)))
 (let (($x941 (= loc_2 2)))
 (let (($x2141 (= invalidFree_1 invalidFree_2)))
 ...
 (let (($x2136 (or $x854 invalidFree_1)))
 (let (($x849 (= loc_1 1)))
 (let (($x2144 (=> $x849 (and (and (and (and (and $x2136 $x858) $x922) $x935) $x2141) $x941))))
 (let (($x2131 (= invalidFree_0 invalidFree_1)))
 ...
 (let (($x2128 (and (and (and (or $x730 invalidFree_0) (or true invalidFree_0)) $x741) $x826)))
 (let (($x701 (= loc_0 5)))
 (let (($x2122 (not invalidFree_0)))
 (let (($x703 (and (and (= H_0 emp) (= AH_0 emp)) $x701)))
 (let (($x2135 (and (and $x703 $x2122) (=> $x701 (and (and (and $x2128 $x843) $x2131) $x849)))))
 (let (($x2192 (and (and (and $x2135 $x2144) (=> $x941 (and (and $x2176 $x2178) $x1251))) $x2191)))
 (let (($x2266 (and (and $x2192 $x2214) (and (=> $x1550 (and (and (and $x2252 $x1746) $x1759) $x1766)) $x2264))))
 (let (($x2303 (and (and (and $x2266 (=> $x1766 (and (and $x2277 $x2279) $x1933))) $x2292) (=> $x2026 (and (and $x2297 $x2299) $x2116)))))
 (and $x2303 invalidFree_9)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
