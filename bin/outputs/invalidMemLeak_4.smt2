...
(assert
 (let (($x831 (= AH_4 (uplus ah7 (pt l16 (Pt_R_1 d11))))))
 (let (($x824 (or (= H_4 (uplus h4 (pt l14 (Pt_R_0 l15)))) (= H_4 (uplus h4 (pt l14 (Pt_R_1 d10)))))))
 (let (($x675 (= loc_4 4)))
 ...
 (let (($x806 (and (and (and (and (and (and $x574 $x572) $x544) $x589) $x608) $x618) $x625)))
 (let (($x513 (= loc_2 3)))
 ...
 (let (($x796 (=> $x434 (and (and (and (and (and $x463 $x461) $x474) $x493) $x506) $x513))))
 ...
 (let (($x307 (or (and (= $i6_main0_0 $i2_main0_0) (= $i7_main01_1 1)) (and (not (= $i6_main0_0 $i2_main0_0)) (= $i7_main01_1 0)))))
 ...
 (let (($x784 (and (and (and (and (and (and $x363 $x352) $x350) $x348) $x320) $x309) $x307)))
 (let (($x271 (= loc_0 1)))
 (let (($x273 (and (and (= H_0 emp) (= AH_0 emp)) $x271)))
 (let (($x790 (and $x273 (=> $x271 (and (and (and (and $x784 $x394) $x403) $x414) $x420)))))
 (let (($x808 (and (and $x790 (and $x796 (=> $x517 (and $x528 $x513)))) (=> $x513 $x806))))
 (and (and $x808 (=> $x625 (and $x670 $x675))) (and (and $x675 $x824) $x831))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
