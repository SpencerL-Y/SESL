...
namespace smack {
    ...
    protected:
        ...
        std::map<std::string, std::string> relatedStruct;
    ...
    public:
        ...
        std::map<std::string, std::string>  getStructInfo() {
            return relatedStruct;
        }

        void bindExprToValue(const Expr* expr, const llvm::Value* v);
    ...
    public:
        ...
        std::string typeDetail(const llvm::Value *v);
