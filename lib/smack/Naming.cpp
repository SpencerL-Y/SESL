...
const std::string Naming::WHATISTHIS_CODE_PROC = "__WHAT_code";
...
const std::string Naming::MEMORY_MY_FUNCTION = "__SMACK_my_memory_check";
const std::string Naming::WHATISTHIS_FUNCTION = "__SMACK_whatIsThis";
