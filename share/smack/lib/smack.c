...
void __SMACK_my_memory_check(void){
  __SMACK_decl("var $myvariable:int;");
  __SMACK_code("$myvariable := 1;");
  __SMACK_code("assert $myvariable == 0;");
  __SMACK_code("/*This is my check*/");
}
