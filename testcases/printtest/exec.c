...
// //   char x;
//   int length = 2;
//   char *arr = __builtin_alloca (length*sizeof(char));
//   if (!arr) return 0;
//   char *a = arr;
...
//     char *arr = __builtin_alloca (2*sizeof(char));
//     char* a = arr;
//     arr[0] = __VERIFIER_nondet_char();
//     arr[1] = __VERIFIER_nondet_char();
//     while(*a != arr[1]){
//         a++;
//     }
// }
