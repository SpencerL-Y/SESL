; ModuleID = '/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/build/b-akjtye33.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@a = internal global [16 x i8] zeroinitializer, align 16, !dbg !0
...
define internal void @foo() #0 !dbg !17 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 getelementptr inbounds ([16 x i8], [16 x i8]* @a, i64 0, i64 0), i8* align 8 %4, i64 8, i1 false), !dbg !25, !verifier.code !20
...
define dso_local i32 @main() #0 !dbg !27 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %2, i8* align 16 getelementptr inbounds ([16 x i8], [16 x i8]* @a, i64 0, i64 0), i64 8, i1 false), !dbg !34, !verifier.code !20
...
entry:
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 0)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 1)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 2)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 3)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 4)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 5)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 6)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 7)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 8)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 9)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 10)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 11)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 12)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 13)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 14)
  store i8 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @a, i32 0, i64 15)
  ret void
}
