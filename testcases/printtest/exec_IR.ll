; ModuleID = '/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/build/b-nfbuui9m.bc'
...
define dso_local i32 @main() #0 !dbg !21 {
  ...
  %3 = load i32, i32* %2, align 4, !dbg !31, !verifier.code !26
  %4 = icmp sgt i32 %3, 10, !dbg !33, !verifier.code !26
  br i1 %4, label %5, label %7, !dbg !34, !verifier.code !26

5:                                                ; preds = %0
  %6 = bitcast i32* %2 to i8*, !dbg !35, !verifier.code !26
  call void @free(i8* %6) #3, !dbg !37, !verifier.code !26
  br label %7, !dbg !38, !verifier.code !26
...
!31 = !DILocation(line: 124, column: 8, scope: !32)
!32 = distinct !DILexicalBlock(scope: !21, file: !1, line: 124, column: 8)
!33 = !DILocation(line: 124, column: 11, scope: !32)
!34 = !DILocation(line: 124, column: 8, scope: !21)
!35 = !DILocation(line: 125, column: 14, scope: !36)
!36 = distinct !DILexicalBlock(scope: !32, file: !1, line: 124, column: 16)
!37 = !DILocation(line: 125, column: 9, scope: !36)
!38 = !DILocation(line: 126, column: 5, scope: !36)
!39 = !DILocation(line: 127, column: 1, scope: !21)
