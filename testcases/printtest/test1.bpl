...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 23742));
...
$bb0:
  ...
  SymbHeap(true|emp)
  call $p0 := malloc(4);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
...
$bb570:
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  $i954 := $sext.i32.i64($i942);
  $i955 := $srem.i64($i954, 2147483648);
  $i956 := $trunc.i64.i32($i955);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "a"} boogie_si_record_i32($i956);
  $i957 := $add.i32($i956, $i956);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "a"} boogie_si_record_i32($i957);
  $i958 := $sext.i32.i64($i946);
  $i959 := $srem.i64($i958, 2147483648);
  $i960 := $trunc.i64.i32($i959);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "b"} boogie_si_record_i32($i960);
  $i961 := $add.i32($i960, $i960);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "b"} boogie_si_record_i32($i961);
  $r := $i949;
  $exn := false;
  return;
$bb571:
...
$bb138:
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  $i452 := $sext.i16.i32($i429);
  $i453 := $srem.i32($i452, 32768);
  $i454 := $trunc.i32.i16($i453);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "a"} boogie_si_record_i16($i454);
  $i455 := $sext.i16.i32($i454);
  $i456 := $sext.i16.i32($i454);
  $i457 := $add.i32($i456, $i455);
  $i458 := $trunc.i32.i16($i457);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "a"} boogie_si_record_i16($i458);
  $i459 := $sext.i16.i32($i436);
  $i460 := $srem.i32($i459, 32768);
  $i461 := $trunc.i32.i16($i460);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "b"} boogie_si_record_i16($i461);
  $i462 := $sext.i16.i32($i461);
  $i463 := $sext.i16.i32($i461);
  $i464 := $add.i32($i463, $i462);
  $i465 := $trunc.i32.i16($i464);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "b"} boogie_si_record_i16($i465);
  $r := $i443;
  $exn := false;
  return;
$bb139:
...
$bb66:
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  $i220 := $sext.i8.i32($i197);
  $i221 := $srem.i32($i220, 128);
  $i222 := $trunc.i32.i8($i221);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "a"} boogie_si_record_i8($i222);
  $i223 := $sext.i8.i32($i222);
  $i224 := $sext.i8.i32($i222);
  $i225 := $add.i32($i224, $i223);
  $i226 := $trunc.i32.i8($i225);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "a"} boogie_si_record_i8($i226);
  $i227 := $sext.i8.i32($i204);
  $i228 := $srem.i32($i227, 128);
  $i229 := $trunc.i32.i8($i228);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "b"} boogie_si_record_i8($i229);
  $i230 := $sext.i8.i32($i229);
  $i231 := $sext.i8.i32($i229);
  $i232 := $add.i32($i231, $i230);
  $i233 := $trunc.i32.i8($i232);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "b"} boogie_si_record_i8($i233);
  $r := $i211;
  $exn := false;
  return;
$bb67:
...
$bb189:
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  $i474 := $add.i32($i462, $i462);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "a"} boogie_si_record_i32($i474);
  $i475 := $sext.i32.i64($i474);
  $i476 := $srem.i64($i475, 2147483648);
  $i477 := $trunc.i64.i32($i476);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "a"} boogie_si_record_i32($i477);
  $i478 := $add.i32($i466, $i466);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "b"} boogie_si_record_i32($i478);
  $i479 := $sext.i32.i64($i478);
  $i480 := $srem.i64($i479, 2147483648);
  $i481 := $trunc.i64.i32($i480);
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  call {:cexpr "b"} boogie_si_record_i32($i481);
  $r := $i470;
  $exn := false;
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 19614));
...
axiom (__SMACK_whatIsThis == $sub.ref(0, 20646));
procedure  __SMACK_whatIsThis()
{
$bb0:
  SymbHeap((true && true)|emp # $p0 >--> 4 # Blk(($p0 + 1), (($p0 + 1) + 4)))
  assert false;
...
axiom (__WHAT_code == $sub.ref(0, 21678));
procedure  __WHAT_code.ref($p0: ref);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 22710));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 23742));
