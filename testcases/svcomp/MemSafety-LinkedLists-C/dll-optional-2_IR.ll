; ModuleID = '/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/testcases/benchmark/b-bcgz27yk.bc'
...
25:                                               ; preds = %24, %7
  ...
  br i1 %27, label %.lr.ph8, label %61, !dbg !48, !verifier.code !14

.lr.ph8:                                          ; preds = %25
  br label %28, !dbg !48, !verifier.code !14

28:                                               ; preds = %forwarder11, %.lr.ph8
  %.06 = phi %struct.TSLL* [ %2, %.lr.ph8 ], [ %36, %forwarder11 ], !verifier.code !14
  call void @llvm.dbg.value(metadata %struct.TSLL* %.06, metadata !47, metadata !DIExpression()), !dbg !30, !verifier.code !14
  %29 = call noalias i8* @malloc(i64 32) #5, !dbg !49, !verifier.code !14
  %30 = bitcast i8* %29 to %struct.TSLL*, !dbg !49, !verifier.code !14
  %31 = getelementptr inbounds %struct.TSLL, %struct.TSLL* %.06, i32 0, i32 0, !dbg !49, !verifier.code !14
  store %struct.TSLL* %30, %struct.TSLL** %31, align 8, !dbg !49, !verifier.code !14
  %32 = getelementptr inbounds %struct.TSLL, %struct.TSLL* %.06, i32 0, i32 0, !dbg !49, !verifier.code !14
  ...
  store %struct.TSLL* %.06, %struct.TSLL** %34, align 8, !dbg !49, !verifier.code !14
  %35 = getelementptr inbounds %struct.TSLL, %struct.TSLL* %.06, i32 0, i32 0, !dbg !49, !verifier.code !14
...
58:                                               ; preds = %57, %40
  ...
  br i1 %60, label %forwarder11, label %._crit_edge9, !dbg !48, !llvm.loop !61, !verifier.code !14

._crit_edge9:                                     ; preds = %58
  br label %61, !dbg !48, !verifier.code !14

61:                                               ; preds = %._crit_edge9, %25
  call void @llvm.dbg.value(metadata %struct.TSLL* %2, metadata !47, metadata !DIExpression()), !dbg !30, !verifier.code !14
  %62 = icmp ne %struct.TSLL* %2, null, !dbg !62, !verifier.code !14
  br i1 %62, label %.lr.ph4, label %78, !dbg !63, !verifier.code !14

.lr.ph4:                                          ; preds = %61
  br label %63, !dbg !63, !verifier.code !14

63:                                               ; preds = %forwarder10, %.lr.ph4
  %.12 = phi %struct.TSLL* [ %2, %.lr.ph4 ], [ %76, %forwarder10 ], !verifier.code !14
...
64:                                               ; preds = %63
  ...
  br i1 %67, label %68, label %72, !dbg !66, !verifier.code !14
...
68:                                               ; preds = %64
  ...
  %71 = icmp eq %struct.TSLL* %70, %.12, !dbg !66, !verifier.code !14
  br i1 %71, label %73, label %72, !dbg !69, !verifier.code !14
...
73:                                               ; preds = %68
  br label %74, !dbg !69, !verifier.code !14

74:                                               ; preds = %73
  %75 = getelementptr inbounds %struct.TSLL, %struct.TSLL* %.12, i32 0, i32 0, !dbg !72, !verifier.code !14
  %76 = load %struct.TSLL*, %struct.TSLL** %75, align 8, !dbg !72, !verifier.code !14
  call void @llvm.dbg.value(metadata %struct.TSLL* %76, metadata !47, metadata !DIExpression()), !dbg !30, !verifier.code !14
  %77 = icmp ne %struct.TSLL* %76, null, !dbg !62, !verifier.code !14
  br i1 %77, label %forwarder10, label %._crit_edge5, !dbg !63, !llvm.loop !73, !verifier.code !14

._crit_edge5:                                     ; preds = %74
  br label %78, !dbg !63, !verifier.code !14

78:                                               ; preds = %._crit_edge5, %61
  call void @llvm.dbg.value(metadata %struct.TSLL* %2, metadata !47, metadata !DIExpression()), !dbg !30, !verifier.code !14
  %79 = icmp ne %struct.TSLL* %2, null, !dbg !75, !verifier.code !14
  br i1 %79, label %.lr.ph, label %93, !dbg !76, !verifier.code !14

.lr.ph:                                           ; preds = %78
  br label %80, !dbg !76, !verifier.code !14

80:                                               ; preds = %forwarder, %.lr.ph
  %.21 = phi %struct.TSLL* [ %2, %.lr.ph ], [ %82, %forwarder ], !verifier.code !14
  ...
  %81 = getelementptr inbounds %struct.TSLL, %struct.TSLL* %.21, i32 0, i32 0, !dbg !77, !verifier.code !14
  %82 = load %struct.TSLL*, %struct.TSLL** %81, align 8, !dbg !77, !verifier.code !14
  call void @llvm.dbg.value(metadata %struct.TSLL* %82, metadata !47, metadata !DIExpression()), !dbg !30, !verifier.code !14
  %83 = getelementptr inbounds %struct.TSLL, %struct.TSLL* %.21, i32 0, i32 3, !dbg !79, !verifier.code !14
  %84 = load i32, i32* %83, align 8, !dbg !79, !verifier.code !14
  %85 = icmp eq i32 %84, 2, !dbg !81, !verifier.code !14
  br i1 %85, label %86, label %90, !dbg !82, !verifier.code !14

86:                                               ; preds = %80
  %87 = getelementptr inbounds %struct.TSLL, %struct.TSLL* %.21, i32 0, i32 2, !dbg !83, !verifier.code !14
  %88 = load %struct.TSLL*, %struct.TSLL** %87, align 8, !dbg !83, !verifier.code !14
  %89 = bitcast %struct.TSLL* %88 to i8*, !dbg !84, !verifier.code !14
  call void @free(i8* %89) #5, !dbg !85, !verifier.code !14
  br label %90, !dbg !85, !verifier.code !14

90:                                               ; preds = %86, %80
  %91 = bitcast %struct.TSLL* %.21 to i8*, !dbg !86, !verifier.code !14
  call void @free(i8* %91) #5, !dbg !87, !verifier.code !14
  call void @llvm.dbg.value(metadata %struct.TSLL* %82, metadata !47, metadata !DIExpression()), !dbg !30, !verifier.code !14
  %92 = icmp ne %struct.TSLL* %82, null, !dbg !75, !verifier.code !14
  br i1 %92, label %forwarder, label %._crit_edge, !dbg !76, !llvm.loop !88, !verifier.code !14

._crit_edge:                                      ; preds = %90
  br label %93, !dbg !76, !verifier.code !14

93:                                               ; preds = %._crit_edge, %78
  ret i32 0, !dbg !90, !verifier.code !14

forwarder:                                        ; preds = %90
  br label %80, !verifier.code !14

forwarder10:                                      ; preds = %74
  br label %63, !verifier.code !14

forwarder11:                                      ; preds = %58
...
!1 = !DIFile(filename: "../svcomp/MemSafety-LinkedLists-C/dll-optional-2.c", directory: "/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/testcases/benchmark")
!2 = !{}
!3 = !{!4}
...
!10 = !DIFile(filename: "../svcomp/MemSafety-LinkedLists-C//dll-optional-2.c", directory: "/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/testcases/benchmark")
