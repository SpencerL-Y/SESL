; ModuleID = '/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/testcases/benchmark/b-fo67p8a2.bc'
...
4:                                                ; preds = %15
  ...
  %5 = call i32 @dll_circular_get_data_at(%struct.node* %1, i32 0), !dbg !166, !verifier.code !22
  %6 = icmp ne i32 2, %5, !dbg !168, !verifier.code !22
...
9:                                                ; preds = %8
  ...
  %10 = call i32 @dll_circular_get_data_at(%struct.node* %1, i32 1), !dbg !166, !verifier.code !22
  %11 = icmp ne i32 3, %10, !dbg !168, !verifier.code !22
...
14:                                               ; preds = %13
  call void @llvm.dbg.value(metadata i32 2, metadata !152, metadata !DIExpression()), !dbg !148, !verifier.code !22
...
!1 = !DIFile(filename: "../svcomp/MemSafety-LinkedLists-C/dll2c_update_all.c", directory: "/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/testcases/benchmark")
!2 = !{}
!3 = !{!4, !13}
!4 = !DIDerivedType(tag: DW_TAG_typedef, name: "DLL", file: !5, line: 13, baseType: !6)
!5 = !DIFile(filename: "../svcomp/MemSafety-LinkedLists-C//dll2c_update_all.c", directory: "/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/testcases/benchmark")
...
!156 = distinct !DILexicalBlock(scope: !157, file: !5, line: 80, column: 30)
...
!162 = distinct !DILexicalBlock(scope: !163, file: !5, line: 84, column: 28)
