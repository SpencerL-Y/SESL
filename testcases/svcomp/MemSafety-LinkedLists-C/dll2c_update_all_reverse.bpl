...
// via /usr/local/bin/smack ../svcomp/MemSafety-LinkedLists-C//dll2c_update_all_reverse.c -ll ../svcomp/MemSafety-LinkedLists-C//dll2c_update_all_reverse_IR.ll --bpl ../svcomp/MemSafety-LinkedLists-C//dll2c_update_all_reverse.bpl -t --sh-mem-leak
...
const dll_circular_destroy: ref;
axiom (dll_circular_destroy == $sub.ref(0, 8256));
procedure  dll_circular_destroy($p0: ref)
{
  var $i1: i1;
  var $p2: ref;
  var $p3: ref;
...
const dll_circular_get_data_at: ref;
axiom (dll_circular_get_data_at == $sub.ref(0, 10320));
procedure  dll_circular_get_data_at($p0: ref, $i1: i32)
  returns ($r: i32)
{
  var $i2: i1;
  var $p4: ref;
  ...
  var $i12: i32;
$bb0:
  call {:cexpr "dll_circular_get_data_at:arg:index"} boogie_si_record_i32($i1);
  $i2 := $sgt.i32($i1, 0);
  $p3 := $p0;
...
const dll_circular_update_at: ref;
axiom (dll_circular_update_at == $sub.ref(0, 11352));
procedure  dll_circular_update_at($p0: ref, $i1: i32, $i2: i32)
{
  var $i3: i1;
  var $p5: ref;
  var $i6: i32;
  ...
  var $p12: ref32;
$bb0:
  call {:cexpr "dll_circular_update_at:arg:data"} boogie_si_record_i32($i1);
  call {:cexpr "dll_circular_update_at:arg:index"} boogie_si_record_i32($i2);
  $i3 := $sgt.i32($i2, 0);
  $p4 := $p0;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
...
$bb3:
  ...
  return;
$bb4:
  $p7 := $add.ref($add.ref($p5, $mul.ref(0, 24)), $mul.ref(0, 1));
  $p8 := $load.ref($M.0, $p7);
...
$bb0:
  ...
  call $p0 := dll_circular_create(2, 1);
  goto $bb1;
$bb1:
  call dll_circular_update_at($p0, 3, 1);
  goto $bb2;
$bb2:
  call dll_circular_update_at($p0, 2, 0);
  goto $bb3;
$bb3:
  goto $bb4;
$bb4:
  call $i1 := dll_circular_get_data_at($p0, 1);
  $i2 := $ne.i32(3, $i1);
  assume {:branchcond $i2} true;
  goto $bb5, $bb7;
$bb5:
...
$bb8:
  ...
  assume false;
$bb9:
  call $i3 := dll_circular_get_data_at($p0, 0);
  $i4 := $ne.i32(2, $i3);
  assume {:branchcond $i4} true;
  goto $bb10, $bb11;
$bb10:
