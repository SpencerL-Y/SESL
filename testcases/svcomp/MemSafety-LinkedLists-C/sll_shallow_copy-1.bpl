...
// via /usr/local/bin/smack ../svcomp/MemSafety-LinkedLists-C//sll_shallow_copy-1.c -ll ../svcomp/MemSafety-LinkedLists-C//sll_shallow_copy-1_IR.ll --bpl ../svcomp/MemSafety-LinkedLists-C//sll_shallow_copy-1.bpl -t --sh-mem-leak
...
$bb0:
  ...
  call $M.0 := $memcpy.i8($M.0, $M.0, $p3, $p4, 8, false);
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  $p6 := $load.ref($M.0, $p5);
