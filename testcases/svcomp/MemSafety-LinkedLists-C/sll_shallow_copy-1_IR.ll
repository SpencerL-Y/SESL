; ModuleID = '/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/testcases/benchmark/b-bjo5v26s.bc'
...
define dso_local i32 @main() #0 !dbg !39 {
  ...
  %4 = bitcast %struct.node* %1 to i8*, !dbg !48, !verifier.code !20
  %5 = bitcast %struct.node* %1 to i8*, !dbg !48, !verifier.code !20
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %4, i8* align 8 %5, i64 8, i1 false), !dbg !48, !verifier.code !20
  %6 = getelementptr inbounds %struct.node, %struct.node* %1, i32 0, i32 0, !dbg !49, !verifier.code !20
  %7 = load %struct.node*, %struct.node** %6, align 8, !dbg !49, !verifier.code !20
  call void @llvm.dbg.value(metadata %struct.node* %7, metadata !50, metadata !DIExpression()), !dbg !44, !verifier.code !20
  %8 = bitcast %struct.node* %1 to i8*, !dbg !51, !verifier.code !20
  call void @free(i8* %8) #4, !dbg !52, !verifier.code !20
  %9 = bitcast %struct.node* %7 to i8*, !dbg !53, !verifier.code !20
  call void @free(i8* %9) #4, !dbg !54, !verifier.code !20
  ret i32 0, !dbg !55, !verifier.code !20
}
...
!1 = !DIFile(filename: "../svcomp/MemSafety-LinkedLists-C/sll_shallow_copy-1.c", directory: "/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/testcases/benchmark")
!2 = !{}
!3 = !{!4, !9}
!4 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !5, size: 64)
!5 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "node", file: !6, line: 8, size: 64, elements: !7)
!6 = !DIFile(filename: "../svcomp/MemSafety-LinkedLists-C//sll_shallow_copy-1.c", directory: "/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/testcases/benchmark")
!7 = !{!8}
...
!48 = !DILocation(line: 29, column: 8, scope: !39)
!49 = !DILocation(line: 31, column: 23, scope: !39)
!50 = !DILocalVariable(name: "t", scope: !39, file: !6, line: 31, type: !4)
!51 = !DILocation(line: 32, column: 8, scope: !39)
!52 = !DILocation(line: 32, column: 3, scope: !39)
!53 = !DILocation(line: 33, column: 8, scope: !39)
!54 = !DILocation(line: 33, column: 3, scope: !39)
!55 = !DILocation(line: 35, column: 3, scope: !39)
