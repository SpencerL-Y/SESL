; ModuleID = '/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/build/b-n7zhf_1x.bc'
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @probe2_6(%struct.A* %0) #0 !dbg !427 {
...
13:                                               ; preds = %10
  br label %19, !dbg !450, !verifier.code !53
...
19:                                               ; preds = %17, %14, %13, %5
  %.0 = phi i32 [ 3, %5 ], [ %7, %17 ], [ %11, %13 ], [ 0, %14 ], !dbg !432, !verifier.code !53
  ret i32 %.0, !dbg !460, !verifier.code !53
}

; Function Attrs: noinline nounwind uwtable
define internal void @disconnect_6(%struct.A* %0) #0 !dbg !461 {
  call void @llvm.dbg.value(metadata %struct.A* %0, metadata !464, metadata !DIExpression()), !dbg !465, !verifier.code !53
  %2 = getelementptr inbounds %struct.A, %struct.A* %0, i32 0, i32 0, !dbg !466, !verifier.code !53
  %3 = load i8*, i8** %2, align 8, !dbg !466, !verifier.code !53
  call void @free(i8* %3) #4, !dbg !467, !verifier.code !53
  ret void, !dbg !468, !verifier.code !53
}

; Function Attrs: noinline nounwind uwtable
define internal void @entry_point() #0 !dbg !469 {
  %1 = call i32 @probe2_6(%struct.A* @a6), !dbg !470, !verifier.code !53
  call void @llvm.dbg.value(metadata i32 %1, metadata !471, metadata !DIExpression()), !dbg !472, !verifier.code !53
  %2 = icmp eq i32 %1, 0, !dbg !473, !verifier.code !53
  br i1 %2, label %3, label %4, !dbg !475, !verifier.code !53

3:                                                ; preds = %0
  call void @disconnect_6(%struct.A* @a6), !dbg !476, !verifier.code !53
  br label %4, !dbg !478, !verifier.code !53

4:                                                ; preds = %3, %0
  store i8* null, i8** getelementptr inbounds (%struct.A, %struct.A* @a6, i32 0, i32 0), align 8, !dbg !479, !verifier.code !53
  ret void, !dbg !480, !verifier.code !53
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @main() #0 !dbg !481 {
  call void @entry_point(), !dbg !482, !verifier.code !53
  ret void, !dbg !483, !verifier.code !53
}
...
entry:
  store i8* null, i8** getelementptr inbounds (%struct.A, %struct.A* @a6, i32 0, i32 0)
  ret void
}
...
!3 = !DIFile(filename: "../testcases/svcomp/ldv-memsafety/memleaks_test6_1.i", directory: "/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/build")
!4 = !{}
!5 = !{!6, !17, !19, !21, !22, !23}
...
!38 = distinct !DIGlobalVariable(name: "a6", scope: !2, file: !3, line: 783, type: !39, isLocal: false, isDefinition: true)
...
!427 = distinct !DISubprogram(name: "probe2_6", scope: !3, file: !3, line: 763, type: !428, scopeLine: 763, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!461 = distinct !DISubprogram(name: "disconnect_6", scope: !3, file: !3, line: 780, type: !462, scopeLine: 780, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!462 = !DISubroutineType(types: !463)
!463 = !{null, !430}
!464 = !DILocalVariable(name: "a", arg: 1, scope: !461, file: !3, line: 780, type: !430)
!465 = !DILocation(line: 0, scope: !461)
!466 = !DILocation(line: 781, column: 10, scope: !461)
!467 = !DILocation(line: 781, column: 2, scope: !461)
!468 = !DILocation(line: 782, column: 1, scope: !461)
!469 = distinct !DISubprogram(name: "entry_point", scope: !3, file: !3, line: 784, type: !192, scopeLine: 784, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!470 = !DILocation(line: 785, column: 12, scope: !469)
!471 = !DILocalVariable(name: "ret", scope: !469, file: !3, line: 785, type: !22)
!472 = !DILocation(line: 0, scope: !469)
!473 = !DILocation(line: 786, column: 8, scope: !474)
!474 = distinct !DILexicalBlock(scope: !469, file: !3, line: 786, column: 5)
!475 = !DILocation(line: 786, column: 5, scope: !469)
!476 = !DILocation(line: 787, column: 3, scope: !477)
!477 = distinct !DILexicalBlock(scope: !474, file: !3, line: 786, column: 13)
!478 = !DILocation(line: 788, column: 2, scope: !477)
!479 = !DILocation(line: 789, column: 7, scope: !469)
!480 = !DILocation(line: 790, column: 1, scope: !469)
!481 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 791, type: !192, scopeLine: 791, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!482 = !DILocation(line: 792, column: 6, scope: !481)
!483 = !DILocation(line: 793, column: 1, scope: !481)
