...
// via /usr/local/bin/smack ../svcomp/memsafety//960521-1-2.c -ll ../svcomp/memsafety//960521-1-2_IR.ll --bpl ../svcomp/memsafety//960521-1-2.bpl -t --sh-mem-leak
...
$bb2:
  ...
  call free_($p21);
  $p22 := $M.3;
  $p23 := $add.ref($p22, $mul.ref($sub.ref(0, 1), 4));
