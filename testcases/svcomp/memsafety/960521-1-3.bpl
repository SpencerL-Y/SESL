...
// via /usr/local/bin/smack ../svcomp/memsafety//960521-1-3.c -ll ../svcomp/memsafety//960521-1-3_IR.ll --bpl ../svcomp/memsafety//960521-1-3.bpl -t --sh-mem-leak
...
$bb0:
  ...
  call foo();
  $p12 := $M.3;
  $p13 := $add.ref($p12, $mul.ref($sub.ref(0, 2), 4));
...
$bb1:
  ...
  call free_($p17);
  $p18 := $M.3;
  $p19 := $add.ref($p18, $mul.ref($sub.ref(0, 1), 4));
...
$bb2:
  ...
  call free_($p22);
  $p23 := $M.3;
  $p24 := $add.ref($p23, $mul.ref($sub.ref(0, 1), 4));
