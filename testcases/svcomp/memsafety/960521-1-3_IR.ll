; ModuleID = '/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/build/b-b2cycj_l.bc'
...
@.str.1 = private unnamed_addr constant [13 x i8] c"960521-1-3.c\00", align 1
...
16:                                               ; preds = %12
  ...
  %18 = icmp slt i32 %17, 127, !dbg !42, !verifier.code !22
...
define dso_local i32 @main() #0 !dbg !46 {
  store i32 128, i32* @n, align 4, !dbg !49, !verifier.code !22
  ...
  %16 = getelementptr inbounds i32, i32* %15, i64 -2, !dbg !61, !verifier.code !22
  %17 = load i32, i32* %16, align 4, !dbg !61, !verifier.code !22
  %18 = icmp ne i32 %17, 0, !dbg !61, !verifier.code !22
  br i1 %18, label %19, label %25, !dbg !63, !verifier.code !22
...
19:                                               ; preds = %0
  ...
  %23 = getelementptr inbounds i32, i32* %22, i64 -1, !dbg !68, !verifier.code !22
  %24 = bitcast i32* %23 to i8*, !dbg !67, !verifier.code !22
  call void @free(i8* %24) #5, !dbg !69, !verifier.code !22
  br label %31, !dbg !70, !verifier.code !22

25:                                               ; preds = %0
  %26 = load i32*, i32** @a, align 8, !dbg !71, !verifier.code !22
  %27 = bitcast i32* %26 to i8*, !dbg !71, !verifier.code !22
  call void @free(i8* %27) #5, !dbg !73, !verifier.code !22
  %28 = load i32*, i32** @b, align 8, !dbg !74, !verifier.code !22
  %29 = getelementptr inbounds i32, i32* %28, i64 -1, !dbg !75, !verifier.code !22
  %30 = bitcast i32* %29 to i8*, !dbg !74, !verifier.code !22
  call void @free(i8* %30) #5, !dbg !76, !verifier.code !22
  br label %31, !verifier.code !22

31:                                               ; preds = %25, %19
  ret i32 0, !dbg !77, !verifier.code !22
}
...
!3 = !DIFile(filename: "../testcases/svcomp/memsafety/960521-1-3.i", directory: "/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/build")
!4 = !{}
!5 = !{!6, !10, !0}
...
!41 = !DILocation(line: 530, column: 29, scope: !39)
...
!68 = !DILocation(line: 541, column: 20, scope: !65)
!69 = !DILocation(line: 541, column: 14, scope: !65)
!70 = !DILocation(line: 541, column: 25, scope: !65)
!71 = !DILocation(line: 543, column: 10, scope: !72)
!72 = distinct !DILexicalBlock(scope: !62, file: !3, line: 543, column: 3)
!73 = !DILocation(line: 543, column: 5, scope: !72)
!74 = !DILocation(line: 543, column: 19, scope: !72)
!75 = !DILocation(line: 543, column: 20, scope: !72)
!76 = !DILocation(line: 543, column: 14, scope: !72)
!77 = !DILocation(line: 544, column: 3, scope: !46)
