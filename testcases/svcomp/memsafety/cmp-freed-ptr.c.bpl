...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/cmp-freed-ptr.c -ll ../testcases/svcomp/memsafety/cmp-freed-ptr.c.ll --bpl ../testcases/svcomp/memsafety/cmp-freed-ptr.c.bpl --verifier boogie --check memleak memory-safety --unroll 3
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 27870));
...
$bb0:
  call $initialize();
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 13, 9} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 14, 24} true;
  assume {:verifier.code 0} true;
  $i2 := $p2i.ref.i64($p1);
  call {:cexpr "adressY"} boogie_si_record_i64($i2);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 16, 10} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p1);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 16, 5} true;
  assume {:verifier.code 0} true;
  call free_($p3);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 18, 9} true;
  assume {:verifier.code 0} true;
  call $p4 := malloc(8);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p4);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 19, 24} true;
  assume {:verifier.code 0} true;
  $i6 := $p2i.ref.i64($p5);
  call {:cexpr "adressX"} boogie_si_record_i64($i6);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 21, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i64($i6, $i2);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 21, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i7 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p5);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 23, 9} true;
  assume {:verifier.code 0} true;
  call free_($p8);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 24, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 21, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 26, 10} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p5);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call free_($p9);
  assume {:sourceloc "../testcases/svcomp/memsafety/cmp-freed-ptr.c", 28, 5} true;
...
axiom (__SMACK_decls == $sub.ref(0, 17550));
type $mop;
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 21678));
...
axiom (__SMACK_my_memory_check == $sub.ref(0, 22710));
...
axiom (__SMACK_decl == $sub.ref(0, 23742));
procedure {:inline 3} __SMACK_decl.ref($p0: ref);
const __SMACK_whatIsThis: ref;
axiom (__SMACK_whatIsThis == $sub.ref(0, 24774));
...
axiom (__WHAT_code == $sub.ref(0, 25806));
procedure {:inline 3} __WHAT_code.ref($p0: ref);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 26838));
procedure {:inline 3} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 27870));
