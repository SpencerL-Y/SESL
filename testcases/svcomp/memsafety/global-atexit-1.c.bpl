...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/global-atexit-1.c -ll ../testcases/svcomp/memsafety/global-atexit-1.c.ll --bpl ../testcases/svcomp/memsafety/global-atexit-1.c.bpl --verifier boogie --check memleak memory-safety --unroll 3
...
const _Exit: ref;
axiom (_Exit == $sub.ref(0, 7230));
procedure {:inline 3} _Exit($i0: i32);
const f: ref;
axiom (f == $sub.ref(0, 8262));
...
axiom (__SMACK_dummy == $sub.ref(0, 14454));
...
axiom (__SMACK_and32 == $sub.ref(0, 15486));
...
axiom (__SMACK_and64 == $sub.ref(0, 16518));
...
axiom (__SMACK_and16 == $sub.ref(0, 17550));
...
axiom (__SMACK_and8 == $sub.ref(0, 18582));
...
axiom (__SMACK_or32 == $sub.ref(0, 19614));
...
axiom (__SMACK_or64 == $sub.ref(0, 20646));
...
axiom (__SMACK_or16 == $sub.ref(0, 21678));
...
axiom (__SMACK_or8 == $sub.ref(0, 22710));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 23742));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 24774));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 25806));
procedure {:inline 3} __SMACK_nondet_int()
  returns ($r: i32);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 26838));
...
axiom (__SMACK_decls == $sub.ref(0, 27870));
type $mop;
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 31998));
...
axiom (__SMACK_my_memory_check == $sub.ref(0, 33030));
...
axiom (__SMACK_decl == $sub.ref(0, 34062));
procedure {:inline 3} __SMACK_decl.ref($p0: ref);
const __SMACK_whatIsThis: ref;
axiom (__SMACK_whatIsThis == $sub.ref(0, 35094));
...
axiom (__WHAT_code == $sub.ref(0, 36126));
procedure {:inline 3} __WHAT_code.ref($p0: ref);
const exit: ref;
axiom (exit == $sub.ref(0, 37158));
