; ModuleID = '/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/build/b-mn36k5u3.bc'
...
2:                                                ; preds = %0
  call void @exit(i32 1) #5, !dbg !37, !verifier.code !19
...
6:                                                ; preds = %0
  ...
  %7 = load i32**, i32*** @g, align 8, !dbg !59, !verifier.code !19
  %8 = load i32*, i32** %7, align 8, !dbg !60, !verifier.code !19
  %9 = bitcast i32* %8 to i8*, !dbg !60, !verifier.code !19
  call void @free(i8* %9) #4, !dbg !61, !verifier.code !19
  %10 = load i32**, i32*** @g, align 8, !dbg !62, !verifier.code !19
  %11 = bitcast i32** %10 to i8*, !dbg !62, !verifier.code !19
  call void @free(i8* %11) #4, !dbg !63, !verifier.code !19
  ret i32 0, !dbg !64, !verifier.code !19
}
...
!3 = !DIFile(filename: "../testcases/svcomp/memsafety/global-atexit-5.c", directory: "/home/clexma/Desktop/Disk_D/Tools/SMACK/SmackBasedPrj/build")
!4 = !{}
!5 = !{!6, !7, !9}
...
!59 = !DILocation(line: 35, column: 8, scope: !47)
!60 = !DILocation(line: 35, column: 7, scope: !47)
!61 = !DILocation(line: 35, column: 2, scope: !47)
!62 = !DILocation(line: 36, column: 7, scope: !47)
!63 = !DILocation(line: 36, column: 2, scope: !47)
!64 = !DILocation(line: 37, column: 2, scope: !47)
