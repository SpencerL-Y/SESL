...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/lockfree-3.1.c -ll ../testcases/svcomp/memsafety/lockfree-3.1.c.ll --bpl ../testcases/svcomp/memsafety/lockfree-3.1.c.bpl --verifier boogie --check memleak memory-safety --unroll 3
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 41274));
...
procedure {:inline 3} $global_allocations()
{
  call $galloc(x1, 8);
  call $galloc(S, 8);
  call $galloc(garbage, 8);
  call $galloc(pc4, 4);
  call $galloc(pc1, 4);
  call $galloc(t1, 8);
  call $galloc(t4, 8);
  call $galloc(x4, 8);
  call $galloc(pop.res4, 4);
...
const pc1: ref;
axiom (pc1 == $sub.ref(0, 1028));
const pc4: ref;
axiom (pc4 == $sub.ref(0, 2056));
const S: ref;
axiom (S == $sub.ref(0, 3088));
const garbage: ref;
axiom (garbage == $sub.ref(0, 4120));
const x1: ref;
axiom (x1 == $sub.ref(0, 5152));
const t1: ref;
axiom (t1 == $sub.ref(0, 6184));
const t4: ref;
axiom (t4 == $sub.ref(0, 7216));
const x4: ref;
axiom (x4 == $sub.ref(0, 8248));
const pop.res4: ref;
axiom (pop.res4 == $sub.ref(0, 9276));
const {:count 14} .str.31: ref;
axiom (.str.31 == $sub.ref(0, 10314));
const push: ref;
axiom (push == $sub.ref(0, 11346));
procedure {:inline 3} push()
{
  var $p0: ref;
  var $p1: ref;
  var $i2: i32;
  ...
  var $p64: ref;
$bb0:
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 24, 16} true;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 24, 16} true;
  $p0 := $bitcast.ref.ref(pc1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 24, 16} true;
  $p1 := $bitcast.ref.ref($i2p.i64.ref(4));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 24, 16} true;
  call __SMACK_check_memory_safety($p0, $p1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 24, 16} true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $i3;
  call {:cexpr "pc1"} boogie_si_record_i32($i3);
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i7 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 40, 24} true;
  $p40 := $bitcast.ref.ref(t1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 40, 24} true;
  ...
  assume {:verifier.code 0} true;
  $p42 := $M.5;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 40, 13} true;
  $p43 := $bitcast.ref.ref(x1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 40, 13} true;
  $p44 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 40, 13} true;
  call __SMACK_check_memory_safety($p43, $p44);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 40, 13} true;
  assume {:verifier.code 0} true;
  $p45 := $M.1;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 40, 17} true;
  assume {:verifier.code 0} true;
  $p46 := $add.ref($add.ref($p45, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 40, 22} true;
  $p47 := $bitcast.ref.ref($p46);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 40, 22} true;
  $p48 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 40, 22} true;
  call __SMACK_check_memory_safety($p47, $p48);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 40, 22} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.ref($M.3, $p46, $p42);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 41, 13} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb5:
  assume !(($i7 == 1));
...
$bb6:
  assume ($i8 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 44, 17} true;
  $p49 := $bitcast.ref.ref(S);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 44, 17} true;
  $p50 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 44, 17} true;
  call __SMACK_check_memory_safety($p49, $p50);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 44, 17} true;
  assume {:verifier.code 0} true;
  $p51 := $M.4;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 44, 22} true;
  $p52 := $bitcast.ref.ref(t1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 44, 22} true;
  ...
  assume {:verifier.code 0} true;
  $p54 := $M.5;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 44, 19} true;
  assume {:verifier.code 0} true;
  $i55 := $eq.ref($p51, $p54);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 44, 17} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i9 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 51, 17} true;
  $p63 := $bitcast.ref.ref(pc1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 51, 17} true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "pc1"} boogie_si_record_i32(1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 52, 13} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb9:
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i11 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 32, 13} true;
  $p29 := $bitcast.ref.ref(x1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 32, 13} true;
  ...
  assume {:verifier.code 0} true;
  $p31 := $M.1;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 32, 17} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref($p31, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 32, 22} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 32, 22} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p32, 4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 33, 13} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb14:
  assume !(($i11 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 36, 18} true;
  $p35 := $bitcast.ref.ref(S);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 36, 18} true;
  ...
  assume {:verifier.code 0} true;
  $p37 := $M.4;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 36, 16} true;
  $p38 := $bitcast.ref.ref(t1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 36, 16} true;
  ...
  assume {:verifier.code 0} true;
  $M.5 := $p37;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 37, 13} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb15:
  assume ($i12 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 26, 18} true;
  assume {:verifier.code 0} true;
  call $p13 := malloc(16);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 26, 18} true;
  assume {:verifier.code 0} true;
  $p14 := $bitcast.ref.ref($p13);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 26, 16} true;
  $p15 := $bitcast.ref.ref(x1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 26, 16} true;
  ...
  assume {:verifier.code 0} true;
  $M.1 := $p13;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 27, 13} true;
  $p17 := $bitcast.ref.ref(x1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 27, 13} true;
  ...
  assume {:verifier.code 0} true;
  $p19 := $M.1;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 27, 17} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p19, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 27, 22} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 28, 13} true;
  $p23 := $bitcast.ref.ref(x1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 28, 13} true;
  ...
  assume {:verifier.code 0} true;
  $p25 := $M.1;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 28, 17} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p25, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 28, 22} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 28, 22} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.ref($M.3, $p26, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 29, 13} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume {:verifier.code 0} true;
  ...
  goto $bb10;
$bb17:
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 54, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb18:
  assume ($i55 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 45, 21} true;
  $p56 := $bitcast.ref.ref(x1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 45, 21} true;
  ...
  assume {:verifier.code 0} true;
  $p58 := $M.1;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 45, 19} true;
  $p59 := $bitcast.ref.ref(S);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 45, 19} true;
  $p60 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 45, 19} true;
  call __SMACK_check_memory_safety($p59, $p60);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 45, 19} true;
  assume {:verifier.code 0} true;
  $M.4 := $p58;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 45, 17} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb19:
  assume !(($i55 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 47, 21} true;
  $p61 := $bitcast.ref.ref(pc1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 47, 21} true;
  $p62 := $bitcast.ref.ref($i2p.i64.ref(4));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 47, 21} true;
  call __SMACK_check_memory_safety($p61, $p62);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 47, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := 3;
  call {:cexpr "pc1"} boogie_si_record_i32(3);
  assume {:verifier.code 0} true;
  goto $bb20;
$bb20:
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 48, 13} true;
  assume {:verifier.code 0} true;
  goto $bb17;
}
const malloc: ref;
axiom (malloc == $sub.ref(0, 12378));
...
const pop: ref;
axiom (pop == $sub.ref(0, 13410));
procedure {:inline 3} pop()
{
  var $p0: ref;
  var $p1: ref;
  var $i2: i32;
  ...
  var $p70: ref;
$bb0:
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 65, 16} true;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 65, 16} true;
  $p0 := $bitcast.ref.ref(pc4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 65, 16} true;
  $p1 := $bitcast.ref.ref($i2p.i64.ref(4));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 65, 16} true;
  call __SMACK_check_memory_safety($p0, $p1);
  ...
  assume {:verifier.code 0} true;
  $M.6 := $i3;
  call {:cexpr "pc4"} boogie_si_record_i32($i3);
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i7 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 76, 18} true;
  $p23 := $bitcast.ref.ref(t4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 76, 18} true;
  $p24 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 76, 18} true;
  call __SMACK_check_memory_safety($p23, $p24);
  ...
  assume {:verifier.code 0} true;
  $p25 := $M.7;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 76, 22} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p25, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 76, 22} true;
  $p27 := $bitcast.ref.ref($p26);
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 76, 22} true;
  assume {:verifier.code 0} true;
  $p29 := $load.ref($M.3, $p26);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 76, 16} true;
  $p30 := $bitcast.ref.ref(x4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 76, 16} true;
  $p31 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 76, 16} true;
  call __SMACK_check_memory_safety($p30, $p31);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 76, 16} true;
  assume {:verifier.code 0} true;
  $M.8 := $p29;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 77, 13} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb5:
  assume !(($i7 == 1));
...
$bb6:
  assume ($i8 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 80, 17} true;
  $p32 := $bitcast.ref.ref(S);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 80, 17} true;
  ...
  assume {:verifier.code 0} true;
  $p34 := $M.4;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 80, 22} true;
  $p35 := $bitcast.ref.ref(t4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 80, 22} true;
  $p36 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 80, 22} true;
  call __SMACK_check_memory_safety($p35, $p36);
  ...
  assume {:verifier.code 0} true;
  $p37 := $M.7;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 80, 19} true;
  assume {:verifier.code 0} true;
  $i38 := $eq.ref($p34, $p37);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 80, 17} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i9 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 87, 20} true;
  $p46 := $bitcast.ref.ref(t4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 87, 20} true;
  ...
  assume {:verifier.code 0} true;
  $p48 := $M.7;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 87, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 87, 24} true;
  assume {:verifier.code 0} true;
  $i52 := $load.i32($M.2, $p49);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 87, 18} true;
  $p53 := $bitcast.ref.ref(pop.res4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 87, 18} true;
  ...
  assume {:verifier.code 0} true;
  $M.9 := $i52;
  call {:cexpr "pop.res4"} boogie_si_record_i32($i52);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 88, 24} true;
  $p55 := $bitcast.ref.ref(garbage);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 88, 24} true;
  $p56 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 88, 24} true;
  call __SMACK_check_memory_safety($p55, $p56);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 88, 24} true;
  assume {:verifier.code 0} true;
  $p57 := $M.10;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 88, 13} true;
  $p58 := $bitcast.ref.ref(t4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 88, 13} true;
  ...
  assume {:verifier.code 0} true;
  $p60 := $M.7;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 88, 17} true;
  assume {:verifier.code 0} true;
  $p61 := $add.ref($add.ref($p60, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 88, 22} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 88, 22} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.ref($M.3, $p61, $p57);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 89, 23} true;
  $p64 := $bitcast.ref.ref(t4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 89, 23} true;
  ...
  assume {:verifier.code 0} true;
  $p66 := $M.7;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 89, 21} true;
  $p67 := $bitcast.ref.ref(garbage);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 89, 21} true;
  $p68 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 89, 21} true;
  call __SMACK_check_memory_safety($p67, $p68);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 89, 21} true;
  assume {:verifier.code 0} true;
  $M.10 := $p66;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 90, 17} true;
  $p69 := $bitcast.ref.ref(pc4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 90, 17} true;
  ...
  assume {:verifier.code 0} true;
  $M.6 := 1;
  call {:cexpr "pc4"} boogie_si_record_i32(1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 91, 13} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb9:
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i10 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 71, 16} true;
  $p17 := $bitcast.ref.ref(t4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 71, 16} true;
  $p18 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 71, 16} true;
  call __SMACK_check_memory_safety($p17, $p18);
  ...
  assume {:verifier.code 0} true;
  $p19 := $M.7;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 71, 19} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.ref($p19, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 71, 16} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i11 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 67, 18} true;
  $p12 := $bitcast.ref.ref(S);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 67, 18} true;
  ...
  assume {:verifier.code 0} true;
  $p14 := $M.4;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 67, 16} true;
  $p15 := $bitcast.ref.ref(t4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 67, 16} true;
  $p16 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 67, 16} true;
  call __SMACK_check_memory_safety($p15, $p16);
  ...
  assume {:verifier.code 0} true;
  $M.7 := $p14;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 68, 13} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume {:verifier.code 0} true;
  ...
  goto $bb10;
$bb15:
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 93, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb16:
  assume ($i20 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 72, 21} true;
  $p21 := $bitcast.ref.ref(pc4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 72, 21} true;
  $p22 := $bitcast.ref.ref($i2p.i64.ref(4));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 72, 21} true;
  call __SMACK_check_memory_safety($p21, $p22);
  ...
  $M.6 := 1;
  call {:cexpr "pc4"} boogie_si_record_i32(1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 72, 17} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb17:
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 71, 16} true;
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 73, 13} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb19:
  assume ($i38 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 81, 21} true;
  $p39 := $bitcast.ref.ref(x4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 81, 21} true;
  ...
  assume {:verifier.code 0} true;
  $p41 := $M.8;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 81, 19} true;
  $p42 := $bitcast.ref.ref(S);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 81, 19} true;
  $p43 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 81, 19} true;
  call __SMACK_check_memory_safety($p42, $p43);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 81, 19} true;
  assume {:verifier.code 0} true;
  $M.4 := $p41;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 81, 17} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb20:
  assume !(($i38 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 83, 21} true;
  $p44 := $bitcast.ref.ref(pc4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 83, 21} true;
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 84, 13} true;
  assume {:verifier.code 0} true;
  goto $bb15;
}
const main: ref;
axiom (main == $sub.ref(0, 14442));
...
$bb0:
  call $initialize();
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 97, 5} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 97, 17} true;
  $p0 := $bitcast.ref.ref(pc1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 97, 17} true;
  $p1 := $bitcast.ref.ref($i2p.i64.ref(4));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 97, 17} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 97, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32(1, $i2);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 97, 21} true;
  assume {:verifier.code 0} true;
  $i4 := 1;
...
$bb4:
  assume !(($i3 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 97, 29} true;
  $p5 := $bitcast.ref.ref(pc4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 97, 29} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $M.6;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 97, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32(1, $i7);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 97, 33} true;
  assume {:verifier.code 0} true;
  $i4 := 1;
  assume {:branchcond $i8} true;
  goto $bb5, $bb6;
...
$bb6:
  assume !(($i8 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 97, 36} true;
...
$bb7:
  assume ($i4 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 98, 13} true;
  assume {:verifier.code 1} true;
...
$bb8:
  assume !(($i4 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 104, 5} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb9:
  assume ($i12 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 99, 13} true;
  assume {:verifier.code 0} true;
  call push();
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 99, 13} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume !(($i12 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 101, 13} true;
  assume {:verifier.code 0} true;
  call pop();
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  ...
  goto $bb1;
$bb12:
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 104, 12} true;
  $p13 := $bitcast.ref.ref(garbage);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 104, 12} true;
...
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 105, 29} true;
  $p17 := $bitcast.ref.ref(garbage);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 105, 29} true;
  $p18 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 105, 29} true;
  call __SMACK_check_memory_safety($p17, $p18);
  ...
  assume {:verifier.code 0} true;
  $p19 := $M.10;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 105, 38} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 105, 38} true;
  assume {:verifier.code 0} true;
  $p23 := $load.ref($M.3, $p20);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 106, 14} true;
  $p24 := $bitcast.ref.ref(garbage);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 106, 14} true;
  ...
  assume {:verifier.code 0} true;
  $p27 := $bitcast.ref.ref($p26);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 106, 9} true;
  assume {:verifier.code 0} true;
  call free_($p27);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 107, 17} true;
  $p28 := $bitcast.ref.ref(garbage);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 107, 17} true;
...
$bb14:
  assume !(($i16 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 110, 7} true;
  $p30 := $bitcast.ref.ref(S);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 110, 7} true;
  $p31 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 110, 7} true;
  call __SMACK_check_memory_safety($p30, $p31);
  ...
  assume {:verifier.code 0} true;
  $M.4 := $0.ref;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 111, 8} true;
  $p32 := $bitcast.ref.ref(t1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 111, 8} true;
  $p33 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 111, 8} true;
  call __SMACK_check_memory_safety($p32, $p33);
  ...
  assume {:verifier.code 0} true;
  $M.5 := $0.ref;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 112, 8} true;
  $p34 := $bitcast.ref.ref(x1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 112, 8} true;
  $p35 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 112, 8} true;
  call __SMACK_check_memory_safety($p34, $p35);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 112, 8} true;
  assume {:verifier.code 0} true;
  $M.1 := $0.ref;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 113, 8} true;
  $p36 := $bitcast.ref.ref(t4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 113, 8} true;
  ...
  assume {:verifier.code 0} true;
  $M.7 := $0.ref;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 114, 8} true;
  $p38 := $bitcast.ref.ref(x4);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 114, 8} true;
  $p39 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 114, 8} true;
  call __SMACK_check_memory_safety($p38, $p39);
  ...
  assume {:verifier.code 0} true;
  $M.8 := $0.ref;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 116, 14} true;
  $p40 := $bitcast.ref.ref(garbage);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 116, 14} true;
  $p41 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 116, 14} true;
  call __SMACK_check_memory_safety($p40, $p41);
  ...
  assume {:verifier.code 0} true;
  $p42 := $M.10;
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 116, 13} true;
  assume {:verifier.code 0} true;
  $i43 := $ne.ref($p42, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 116, 13} true;
  assume {:verifier.code 0} true;
  $i44 := $xor.i1($i43, 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 116, 12} true;
  assume {:verifier.code 0} true;
  $i45 := $xor.i1($i44, 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 116, 12} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i1.i32($i45);
  assume {:sourceloc "../testcases/svcomp/memsafety/lockfree-3.1.c", 116, 5} true;
...
axiom (__SMACK_dummy == $sub.ref(0, 18570));
...
axiom (__SMACK_and32 == $sub.ref(0, 19602));
...
axiom (__SMACK_and64 == $sub.ref(0, 20634));
...
axiom (__SMACK_and16 == $sub.ref(0, 21666));
...
axiom (__SMACK_and8 == $sub.ref(0, 22698));
...
axiom (__SMACK_or32 == $sub.ref(0, 23730));
...
axiom (__SMACK_or64 == $sub.ref(0, 24762));
...
axiom (__SMACK_or16 == $sub.ref(0, 25794));
...
axiom (__SMACK_or8 == $sub.ref(0, 26826));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 27858));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 28890));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 29922));
procedure {:inline 3} __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 30954));
type $mop;
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 35082));
...
axiom (__SMACK_my_memory_check == $sub.ref(0, 36114));
...
axiom (__SMACK_decl == $sub.ref(0, 37146));
procedure {:inline 3} __SMACK_decl.ref($p0: ref);
const __SMACK_whatIsThis: ref;
axiom (__SMACK_whatIsThis == $sub.ref(0, 38178));
...
axiom (__WHAT_code == $sub.ref(0, 39210));
procedure {:inline 3} __WHAT_code.ref($p0: ref);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 40242));
procedure {:inline 3} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 41274));
