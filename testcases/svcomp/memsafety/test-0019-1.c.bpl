...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/test-0019-1.c -ll ../testcases/svcomp/memsafety/test-0019-1.c.ll --bpl ../testcases/svcomp/memsafety/test-0019-1.c.bpl --verifier boogie --check memleak memory-safety --unroll 3
...
procedure {:inline 3} free_data($p0: ref, $p1: ref)
{
  var $p2: ref;
  var $p3: ref;
  var $p4: ref;
