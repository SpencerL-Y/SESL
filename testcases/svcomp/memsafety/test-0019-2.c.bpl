...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/test-0019-2.c -ll ../testcases/svcomp/memsafety/test-0019-2.c.ll --bpl ../testcases/svcomp/memsafety/test-0019-2.c.bpl --verifier boogie --check memleak memory-safety --unroll 3
...
axiom (alloc_data == $sub.ref(0, 4134));
procedure {:inline 3} alloc_data($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
...
const free_data: ref;
axiom (free_data == $sub.ref(0, 5166));
procedure {:inline 3} free_data($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
