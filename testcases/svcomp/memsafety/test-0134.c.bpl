...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/test-0134.c -ll ../testcases/svcomp/memsafety/test-0134.c.ll --bpl ../testcases/svcomp/memsafety/test-0134.c.bpl --verifier boogie --check memleak memory-safety --unroll 3
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  $p10 := $load.ref($M.0, $p7);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0134.c", 116, 10} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  return;
$bb4:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0134.c", 114, 9} true;
  assume {:verifier.code 0} true;
...
const list_add: ref;
axiom (list_add == $sub.ref(0, 12398));
...
const list_del: ref;
axiom (list_del == $sub.ref(0, 13430));
procedure {:inline 3} list_del($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
...
axiom (__list_del == $sub.ref(0, 14462));
