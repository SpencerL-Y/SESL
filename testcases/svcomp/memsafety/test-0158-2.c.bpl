...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/test-0158-2.c -ll ../testcases/svcomp/memsafety/test-0158-2.c.ll --bpl ../testcases/svcomp/memsafety/test-0158-2.c.bpl --verifier boogie --check memleak memory-safety --unroll 3
...
$bb0:
  ...
  $p12 := $add.ref($add.ref($add.ref($p10, $mul.ref(0, 24)), $mul.ref(0, 1)), $mul.ref(1, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0158-2.c", 27, 19} true;
  $p13 := $bitcast.ref.ref($p12);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0158-2.c", 27, 19} true;
  $p14 := $bitcast.ref.ref($i2p.i64.ref(1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0158-2.c", 27, 19} true;
