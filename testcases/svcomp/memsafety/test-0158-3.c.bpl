...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/test-0158-3.c -ll ../testcases/svcomp/memsafety/test-0158-3.c.ll --bpl ../testcases/svcomp/memsafety/test-0158-3.c.bpl --verifier boogie --check memleak memory-safety --unroll 3
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 28902));
...
$bb0:
  ...
  $p16 := $add.ref($add.ref($add.ref($p14, $mul.ref(0, 24)), $mul.ref(0, 1)), $mul.ref(1, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0158-3.c", 31, 19} true;
  $p17 := $bitcast.ref.ref($p16);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0158-3.c", 31, 19} true;
  $p18 := $bitcast.ref.ref($i2p.i64.ref(1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0158-3.c", 31, 19} true;
  call __SMACK_check_memory_safety($p17, $p18);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0158-3.c", 31, 19} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p16, 8);
...
axiom (__SMACK_decls == $sub.ref(0, 18582));
type $mop;
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 22710));
...
axiom (__SMACK_my_memory_check == $sub.ref(0, 23742));
...
axiom (__SMACK_decl == $sub.ref(0, 24774));
procedure {:inline 3} __SMACK_decl.ref($p0: ref);
const __SMACK_whatIsThis: ref;
axiom (__SMACK_whatIsThis == $sub.ref(0, 25806));
...
axiom (__WHAT_code == $sub.ref(0, 26838));
procedure {:inline 3} __WHAT_code.ref($p0: ref);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 27870));
procedure {:inline 3} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 28902));
