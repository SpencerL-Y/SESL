...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/test-0219.c -ll ../testcases/svcomp/memsafety/test-0219.c.ll --bpl ../testcases/svcomp/memsafety/test-0219.c.bpl --verifier boogie --check memleak memory-safety --unroll 3
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 37158));
...
$bb5:
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0219.c", 78, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, main.list, $p8);
...
const l1_insert: ref;
axiom (l1_insert == $sub.ref(0, 4134));
...
axiom (l2_destroy == $sub.ref(0, 5166));
...
const free_: ref;
axiom (free_ == $sub.ref(0, 6198));
procedure {:inline 3} free_($p0: ref)
{
  call $free($p0);
}
const calloc_model: ref;
axiom (calloc_model == $sub.ref(0, 7230));
...
const l2_insert: ref;
axiom (l2_insert == $sub.ref(0, 8262));
...
axiom (__SMACK_dummy == $sub.ref(0, 13422));
...
axiom (__SMACK_and32 == $sub.ref(0, 14454));
...
axiom (__SMACK_and64 == $sub.ref(0, 15486));
...
axiom (__SMACK_and16 == $sub.ref(0, 16518));
...
axiom (__SMACK_and8 == $sub.ref(0, 17550));
...
axiom (__SMACK_or32 == $sub.ref(0, 18582));
...
axiom (__SMACK_or64 == $sub.ref(0, 19614));
...
axiom (__SMACK_or16 == $sub.ref(0, 20646));
...
axiom (__SMACK_or8 == $sub.ref(0, 21678));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 22710));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 23742));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 24774));
procedure {:inline 3} __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 25806));
type $mop;
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 29934));
...
axiom (__SMACK_my_memory_check == $sub.ref(0, 30966));
...
axiom (__SMACK_decl == $sub.ref(0, 31998));
procedure {:inline 3} __SMACK_decl.ref($p0: ref);
const __SMACK_whatIsThis: ref;
axiom (__SMACK_whatIsThis == $sub.ref(0, 33030));
...
axiom (__WHAT_code == $sub.ref(0, 34062));
procedure {:inline 3} __WHAT_code.ref($p0: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 35094));
...
axiom (llvm.dbg.value == $sub.ref(0, 36126));
procedure {:inline 3} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 37158));
