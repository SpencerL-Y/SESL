...
axiom (main.list == $sub.ref(0, 4169));
const reach_error: ref;
axiom (reach_error == $sub.ref(0, 5201));
procedure  reach_error()
{
$bb0:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0235-1.c", 3, 22} true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0235-1.c", 3, 22} true;
...
axiom (__assert_fail == $sub.ref(0, 6233));
procedure  __assert_fail($p0: ref, $p1: ref, $i2: i32, $p3: ref);
const main: ref;
axiom (main == $sub.ref(0, 7265));
...
const l0_insert: ref;
axiom (l0_insert == $sub.ref(0, 8297));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 9329));
procedure  __VERIFIER_nondet_int()
  returns ($r: i32);
const l0_destroy: ref;
axiom (l0_destroy == $sub.ref(0, 10361));
...
axiom (llvm.dbg.declare == $sub.ref(0, 11393));
procedure  llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const l1_destroy: ref;
axiom (l1_destroy == $sub.ref(0, 12425));
...
const free_: ref;
axiom (free_ == $sub.ref(0, 13457));
procedure  free_($p0: ref)
{
  call $free($p0);
}
const l2_destroy: ref;
axiom (l2_destroy == $sub.ref(0, 14489));
...
axiom (l3_destroy == $sub.ref(0, 15521));
...
axiom (l4_destroy == $sub.ref(0, 16553));
...
axiom (zalloc_or_die == $sub.ref(0, 17585));
...
const l1_insert: ref;
axiom (l1_insert == $sub.ref(0, 18617));
...
const l2_insert: ref;
axiom (l2_insert == $sub.ref(0, 19649));
...
const l3_insert: ref;
axiom (l3_insert == $sub.ref(0, 20681));
...
const l4_insert: ref;
axiom (l4_insert == $sub.ref(0, 21713));
...
axiom (calloc_model == $sub.ref(0, 22745));
...
const abort: ref;
axiom (abort == $sub.ref(0, 23777));
procedure  abort();
const malloc: ref;
axiom (malloc == $sub.ref(0, 24809));
...
axiom (llvm.memset.p0i8.i64 == $sub.ref(0, 25841));
procedure  llvm.memset.p0i8.i64($p0: ref, $i1: i8, $i2: i64, $i3: i1);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 26873));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 27905));
