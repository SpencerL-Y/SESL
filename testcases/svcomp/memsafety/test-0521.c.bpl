...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/test-0521.c -ll ../testcases/svcomp/memsafety/test-0521.c.ll --bpl ../testcases/svcomp/memsafety/test-0521.c.bpl --verifier boogie --check memleak memory-safety --unroll 3
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 31998));
axiom ($EXTERNS_BOTTOM == $add.ref($GLOBALS_BOTTOM, $sub.ref(0, 32768)));
axiom ($MALLOC_TOP == 9223372036854775807);
function {:inline} $isExternal(p: ref) returns (bool) { $slt.ref.bool(p, $EXTERNS_BOTTOM) }

// Global allocations
procedure {:inline 3} $global_allocations()
{
  call $galloc(.str.31, 14);
}
...
axiom (.str.31 == $sub.ref(0, 1038));
const main: ref;
axiom (main == $sub.ref(0, 2070));
...
$bb0:
  call $initialize();
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 33, 7} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 33, 14} true;
...
$bb2:
  assume ($i6 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 37, 31} true;
  assume {:verifier.code 0} true;
  call $p7 := malloc(16);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 37, 31} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p7);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 38, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.ref($p8, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 38, 15} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i6 == 1));
  assume true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 66, 19} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 66, 24} true;
  $p27 := $bitcast.ref.ref($p26);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 66, 24} true;
  $p28 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 66, 24} true;
  call __SMACK_check_memory_safety($p27, $p28);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 66, 24} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.ref($M.3, $p26, $p4);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 66, 24} true;
  assume {:verifier.code 0} true;
  $i29 := $ne.ref($p4, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 66, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb8, $bb9;
$bb4:
  assume ($i9 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 41, 17} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p8, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 41, 22} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 42, 25} true;
  assume {:verifier.code 1} true;
  call $i13 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i13);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 42, 17} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p8, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 42, 23} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 44, 31} true;
  assume {:verifier.code 0} true;
  call $p17 := malloc(16);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 44, 31} true;
  assume {:verifier.code 0} true;
  $p18 := $bitcast.ref.ref($p17);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 45, 16} true;
  assume {:verifier.code 0} true;
  $i19 := $ne.ref($p18, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 45, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb6, $bb7;
$bb5:
  assume !(($i9 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 39, 15} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 39, 15} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i19 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 48, 17} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p18, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 48, 23} true;
  $p21 := $bitcast.ref.ref($p20);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 48, 23} true;
  $p22 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 48, 23} true;
  call __SMACK_check_memory_safety($p21, $p22);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 48, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p20, $p7);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 49, 17} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($add.ref($p18, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 49, 22} true;
  $p24 := $bitcast.ref.ref($p23);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 49, 22} true;
  $p25 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 49, 22} true;
  call __SMACK_check_memory_safety($p24, $p25);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 49, 22} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.ref($M.2, $p23, $p4);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 33, 7} true;
  assume {:verifier.code 0} true;
  $p4 := $p17;
  goto $bb1;
$bb7:
  assume !(($i19 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 46, 15} true;
  assume {:verifier.code 0} true;
  call abort();
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 46, 15} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i29 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 67, 29} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 67, 29} true;
  assume {:verifier.code 0} true;
  $p33 := $load.ref($M.0, $p30);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 67, 16} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 67, 21} true;
  $p35 := $bitcast.ref.ref($p34);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 67, 21} true;
  $p36 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 67, 21} true;
  call __SMACK_check_memory_safety($p35, $p36);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 67, 21} true;
  assume {:verifier.code 0} true;
  $M.4 := $store.ref($M.4, $p34, $p33);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 67, 11} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 66, 13} true;
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 75, 19} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 75, 19} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 75, 19} true;
  assume {:verifier.code 0} true;
  $p40 := $load.ref($M.3, $p37);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 75, 14} true;
  assume {:verifier.code 0} true;
  $i41 := $ne.ref($p40, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 75, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i41} true;
  goto $bb11, $bb12;
$bb11:
  assume ($i41 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 78, 39} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 78, 39} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 78, 39} true;
  assume {:verifier.code 0} true;
  $p46 := $load.ref($M.4, $p43);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 79, 37} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 79, 37} true;
  call __SMACK_check_memory_safety($p48, $p49);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 79, 37} true;
  assume {:verifier.code 0} true;
  $p50 := $load.ref($M.0, $p47);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 79, 21} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 79, 26} true;
  $p52 := $bitcast.ref.ref($p51);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 79, 26} true;
  $p53 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 79, 26} true;
  call __SMACK_check_memory_safety($p52, $p53);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 79, 26} true;
  assume {:verifier.code 0} true;
  $M.4 := $store.ref($M.4, $p51, $p50);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 79, 26} true;
  assume {:verifier.code 0} true;
  $i54 := $ne.ref($p50, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 79, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i54} true;
  goto $bb14, $bb15;
$bb12:
  assume !(($i41 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 76, 11} true;
  assume {:verifier.code 0} true;
  $p42 := $0.ref;
  goto $bb13;
$bb13:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 90, 7} true;
  assume {:verifier.code 0} true;
  $p78 := $p42;
  goto $bb20;
$bb14:
  assume ($i54 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 80, 13} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb15:
  assume !(($i54 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 35} true;
  assume {:verifier.code 0} true;
  $p55 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 35} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 35} true;
  assume {:verifier.code 0} true;
  $p58 := $load.ref($M.3, $p55);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 41} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 41} true;
  assume {:verifier.code 0} true;
  $p62 := $load.ref($M.2, $p59);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 23} true;
  assume {:verifier.code 0} true;
  $p63 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 28} true;
  $p64 := $bitcast.ref.ref($p63);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 28} true;
  $p65 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 28} true;
  call __SMACK_check_memory_safety($p64, $p65);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 28} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.ref($M.3, $p63, $p62);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 28} true;
  assume {:verifier.code 0} true;
  $i66 := $ne.ref($p62, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 17} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume ($i66 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 32} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 32} true;
  $p68 := $bitcast.ref.ref($p67);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 32} true;
  $p69 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 32} true;
  call __SMACK_check_memory_safety($p68, $p69);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 32} true;
  assume {:verifier.code 0} true;
  $p70 := $load.ref($M.3, $p67);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 38} true;
  assume {:verifier.code 0} true;
  $p71 := $add.ref($add.ref($p70, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 38} true;
  $p72 := $bitcast.ref.ref($p71);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 38} true;
  $p73 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 38} true;
  call __SMACK_check_memory_safety($p72, $p73);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 38} true;
  assume {:verifier.code 0} true;
  $p74 := $load.ref($M.0, $p71);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 20} true;
  assume {:verifier.code 0} true;
  $p75 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 25} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 25} true;
  assume {:verifier.code 0} true;
  $M.4 := $store.ref($M.4, $p75, $p74);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 83, 15} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb18:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 82, 17} true;
...
$bb21:
  assume ($i79 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 96, 21} true;
  assume {:verifier.code 0} true;
  $p80 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 96, 21} true;
  $p81 := $bitcast.ref.ref($p80);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 96, 21} true;
  $p82 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 96, 21} true;
  call __SMACK_check_memory_safety($p81, $p82);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 96, 21} true;
  assume {:verifier.code 0} true;
  $p83 := $load.ref($M.3, $p80);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 96, 16} true;
  assume {:verifier.code 0} true;
  $i84 := $ne.ref($p83, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 96, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i84} true;
  goto $bb23, $bb24;
$bb22:
  assume !(($i79 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 121, 7} true;
  assume {:verifier.code 0} true;
  $p121 := $p4;
  goto $bb32;
$bb23:
  assume ($i84 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 99, 41} true;
  assume {:verifier.code 0} true;
  $p86 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 99, 41} true;
  $p87 := $bitcast.ref.ref($p86);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 99, 41} true;
  $p88 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 99, 41} true;
  call __SMACK_check_memory_safety($p87, $p88);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 99, 41} true;
  assume {:verifier.code 0} true;
  $p89 := $load.ref($M.4, $p86);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 39} true;
  assume {:verifier.code 0} true;
  $p90 := $add.ref($add.ref($p89, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 39} true;
  $p91 := $bitcast.ref.ref($p90);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 39} true;
  $p92 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 39} true;
  call __SMACK_check_memory_safety($p91, $p92);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 39} true;
  assume {:verifier.code 0} true;
  $p93 := $load.ref($M.0, $p90);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 23} true;
  assume {:verifier.code 0} true;
  $p94 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 28} true;
  $p95 := $bitcast.ref.ref($p94);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 28} true;
  $p96 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 28} true;
  call __SMACK_check_memory_safety($p95, $p96);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 28} true;
  assume {:verifier.code 0} true;
  $M.4 := $store.ref($M.4, $p94, $p93);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 28} true;
  assume {:verifier.code 0} true;
  $i97 := $ne.ref($p93, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 100, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i97} true;
  goto $bb26, $bb27;
$bb24:
  assume !(($i84 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 97, 13} true;
  assume {:verifier.code 0} true;
  $p85 := $0.ref;
  goto $bb25;
$bb25:
...
$bb26:
  assume ($i97 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 101, 15} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb27:
  assume !(($i97 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 37} true;
  assume {:verifier.code 0} true;
  $p98 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 37} true;
  $p99 := $bitcast.ref.ref($p98);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 37} true;
  $p100 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 37} true;
  call __SMACK_check_memory_safety($p99, $p100);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 37} true;
  assume {:verifier.code 0} true;
  $p101 := $load.ref($M.3, $p98);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 43} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 43} true;
  call __SMACK_check_memory_safety($p103, $p104);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 43} true;
  assume {:verifier.code 0} true;
  $p105 := $load.ref($M.2, $p102);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 25} true;
  assume {:verifier.code 0} true;
  $p106 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 30} true;
  $p107 := $bitcast.ref.ref($p106);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 30} true;
  $p108 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 30} true;
  call __SMACK_check_memory_safety($p107, $p108);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 30} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.ref($M.3, $p106, $p105);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 30} true;
  assume {:verifier.code 0} true;
  $i109 := $ne.ref($p105, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 19} true;
  assume {:verifier.code 0} true;
...
$bb29:
  assume ($i109 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 34} true;
  assume {:verifier.code 0} true;
  $p110 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 34} true;
  $p111 := $bitcast.ref.ref($p110);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 34} true;
  $p112 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 34} true;
  call __SMACK_check_memory_safety($p111, $p112);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 34} true;
  assume {:verifier.code 0} true;
  $p113 := $load.ref($M.3, $p110);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 40} true;
  assume {:verifier.code 0} true;
  $p114 := $add.ref($add.ref($p113, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 40} true;
  $p115 := $bitcast.ref.ref($p114);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 40} true;
  $p116 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 40} true;
  call __SMACK_check_memory_safety($p115, $p116);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 40} true;
  assume {:verifier.code 0} true;
  $p117 := $load.ref($M.0, $p114);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 22} true;
  assume {:verifier.code 0} true;
  $p118 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 27} true;
  $p119 := $bitcast.ref.ref($p118);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 27} true;
  $p120 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 27} true;
  call __SMACK_check_memory_safety($p119, $p120);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 27} true;
  assume {:verifier.code 0} true;
  $M.4 := $store.ref($M.4, $p118, $p117);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 104, 17} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb30:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 103, 19} true;
...
$bb32:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 121, 14} true;
  assume {:verifier.code 0} true;
  $i122 := $ne.ref($p121, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 121, 19} true;
  assume {:verifier.code 0} true;
  $i123 := 0;
...
$bb33:
  assume ($i122 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 121, 28} true;
  assume {:verifier.code 0} true;
  $p124 := $add.ref($add.ref($p121, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 121, 28} true;
  $p125 := $bitcast.ref.ref($p124);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 121, 28} true;
  $p126 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 121, 28} true;
  call __SMACK_check_memory_safety($p125, $p126);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 121, 28} true;
  assume {:verifier.code 0} true;
  $p127 := $load.ref($M.2, $p124);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 121, 19} true;
  assume {:verifier.code 0} true;
  $i128 := $ne.ref($p127, $0.ref);
  assume {:verifier.code 0} true;
  $i123 := $i128;
  goto $bb35;
$bb34:
...
$bb36:
  assume ($i123 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 127, 9} true;
  assume {:verifier.code 0} true;
  $p129, $p130 := $p121, $0.ref;
  goto $bb38;
$bb37:
  assume !(($i123 == 1));
  assume true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 204, 19} true;
  assume {:verifier.code 0} true;
  $p198 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 204, 24} true;
  $p199 := $bitcast.ref.ref($p198);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 204, 24} true;
  $p200 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 204, 24} true;
  call __SMACK_check_memory_safety($p199, $p200);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 204, 24} true;
  assume {:verifier.code 0} true;
  $M.6 := $store.ref($M.6, $p198, $p121);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 204, 24} true;
  assume {:verifier.code 0} true;
  $i201 := $ne.ref($p121, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 204, 13} true;
  assume {:verifier.code 0} true;
...
$bb39:
  assume ($i131 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 128, 37} true;
  assume {:verifier.code 0} true;
  $p133 := $add.ref($add.ref($p129, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 128, 37} true;
  $p134 := $bitcast.ref.ref($p133);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 128, 37} true;
  $p135 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 128, 37} true;
  call __SMACK_check_memory_safety($p134, $p135);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 128, 37} true;
  assume {:verifier.code 0} true;
  $p136 := $load.ref($M.2, $p133);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 129, 16} true;
  assume {:verifier.code 0} true;
  $i137 := $ne.ref($p136, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 129, 15} true;
  assume {:verifier.code 0} true;
...
$bb42:
  assume ($i137 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 143, 40} true;
  assume {:verifier.code 0} true;
  $p141 := $add.ref($add.ref($p129, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 144, 39} true;
  assume {:verifier.code 0} true;
  $p142 := $add.ref($add.ref($p129, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 144, 39} true;
  $p143 := $bitcast.ref.ref($p142);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 144, 39} true;
  $p144 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 144, 39} true;
  call __SMACK_check_memory_safety($p143, $p144);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 144, 39} true;
  assume {:verifier.code 0} true;
  $p145 := $load.ref($M.0, $p142);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 144, 26} true;
  $p146 := $bitcast.ref.ref($p1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 144, 26} true;
  $p147 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 144, 26} true;
  call __SMACK_check_memory_safety($p146, $p147);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 144, 26} true;
  assume {:verifier.code 0} true;
  $M.5 := $store.ref($M.5, $p1, $p145);
  assume true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 145, 39} true;
  assume {:verifier.code 0} true;
  $p148 := $add.ref($add.ref($p136, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 145, 39} true;
  $p149 := $bitcast.ref.ref($p148);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 145, 39} true;
  $p150 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 145, 39} true;
  call __SMACK_check_memory_safety($p149, $p150);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 145, 39} true;
  assume {:verifier.code 0} true;
  $p151 := $load.ref($M.0, $p148);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 145, 26} true;
  $p152 := $bitcast.ref.ref($p2);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 145, 26} true;
  $p153 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 145, 26} true;
  call __SMACK_check_memory_safety($p152, $p153);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 145, 26} true;
  assume {:verifier.code 0} true;
  $M.5 := $store.ref($M.5, $p2, $p151);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 13} true;
  assume {:verifier.code 0} true;
  $p154 := $p129;
  goto $bb44;
$bb43:
  assume !(($i137 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 131, 19} true;
  assume {:verifier.code 0} true;
  $p138 := $add.ref($add.ref($p129, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 131, 24} true;
  $p139 := $bitcast.ref.ref($p138);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 131, 24} true;
  $p140 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 131, 24} true;
  call __SMACK_check_memory_safety($p139, $p140);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 131, 24} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.ref($M.2, $p138, $p130);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 133, 13} true;
  assume {:verifier.code 0} true;
  $p132 := $p129;
  goto $bb41;
$bb44:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 20} true;
  $p155 := $bitcast.ref.ref($p1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 20} true;
  $p156 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 20} true;
  call __SMACK_check_memory_safety($p155, $p156);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 20} true;
  assume {:verifier.code 0} true;
  $p157 := $load.ref($M.5, $p1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 20} true;
  assume {:verifier.code 0} true;
  $i158 := $ne.ref($p157, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 25} true;
  assume {:verifier.code 0} true;
  $i159 := 1;
...
$bb47:
  assume !(($i158 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 28} true;
  $p160 := $bitcast.ref.ref($p2);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 28} true;
  $p161 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 28} true;
  call __SMACK_check_memory_safety($p160, $p161);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 28} true;
  assume {:verifier.code 0} true;
  $p162 := $load.ref($M.5, $p2);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 25} true;
  assume {:verifier.code 0} true;
  $i163 := $ne.ref($p162, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 25} true;
  assume {:verifier.code 0} true;
  $i159 := $i163;
  goto $bb46;
$bb48:
  assume ($i159 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 20} true;
  $p164 := $bitcast.ref.ref($p2);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 20} true;
  $p165 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 20} true;
  call __SMACK_check_memory_safety($p164, $p165);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 20} true;
  assume {:verifier.code 0} true;
  $p166 := $load.ref($M.5, $p2);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 20} true;
  assume {:verifier.code 0} true;
  $i167 := $ne.ref($p166, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 25} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i167} true;
  goto $bb50, $bb51;
$bb49:
  assume !(($i159 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 179, 17} true;
  assume {:verifier.code 0} true;
  $p190 := $add.ref($add.ref($p129, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 179, 22} true;
  $p191 := $bitcast.ref.ref($p190);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 179, 22} true;
  $p192 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 179, 22} true;
  call __SMACK_check_memory_safety($p191, $p192);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 179, 22} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.ref($M.2, $p190, $p130);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 183, 24} true;
  assume {:verifier.code 0} true;
  $p193 := $add.ref($add.ref($p136, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 183, 24} true;
  $p194 := $bitcast.ref.ref($p193);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 183, 24} true;
  $p195 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 183, 24} true;
  call __SMACK_check_memory_safety($p194, $p195);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 183, 24} true;
  assume {:verifier.code 0} true;
  $p196 := $load.ref($M.2, $p193);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 184, 16} true;
  assume {:verifier.code 0} true;
  $p197 := $bitcast.ref.ref($p136);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 184, 11} true;
  assume {:verifier.code 0} true;
  call free_($p197);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 127, 9} true;
  assume {:verifier.code 0} true;
...
$bb50:
  assume ($i167 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 29} true;
  $p168 := $bitcast.ref.ref($p1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 29} true;
  $p169 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 29} true;
  call __SMACK_check_memory_safety($p168, $p169);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 29} true;
  assume {:verifier.code 0} true;
  $p170 := $load.ref($M.5, $p1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 29} true;
  assume {:verifier.code 0} true;
  $i171 := $ne.ref($p170, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 34} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  goto $bb52;
$bb52:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 160, 17} true;
  assume {:verifier.code 0} true;
  $p174 := $p1;
  goto $bb58;
$bb53:
  assume ($i171 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 37} true;
  assume {:verifier.code 1} true;
  call $i172 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i172);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 37} true;
  assume {:verifier.code 0} true;
  $i173 := $ne.i32($i172, 0);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 159, 19} true;
  assume {:verifier.code 0} true;
...
$bb58:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 167, 35} true;
  $p175 := $bitcast.ref.ref($p174);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 167, 35} true;
  $p176 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 167, 35} true;
  call __SMACK_check_memory_safety($p175, $p176);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 167, 35} true;
  assume {:verifier.code 0} true;
  $p177 := $load.ref($M.5, $p174);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 168, 30} true;
  assume {:verifier.code 0} true;
  $p178 := $add.ref($add.ref($p177, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 168, 30} true;
  $p179 := $bitcast.ref.ref($p178);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 168, 30} true;
  $p180 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 168, 30} true;
  call __SMACK_check_memory_safety($p179, $p180);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 168, 30} true;
  assume {:verifier.code 0} true;
  $p181 := $load.ref($M.0, $p178);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 168, 22} true;
  $p182 := $bitcast.ref.ref($p174);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 168, 22} true;
  $p183 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 168, 22} true;
  call __SMACK_check_memory_safety($p182, $p183);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 168, 22} true;
  assume {:verifier.code 0} true;
  $M.5 := $store.ref($M.5, $p174, $p181);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 169, 21} true;
  assume {:verifier.code 0} true;
  $p184 := $add.ref($add.ref($p177, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 169, 26} true;
  $p185 := $bitcast.ref.ref($p184);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 169, 26} true;
  $p186 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 169, 26} true;
  call __SMACK_check_memory_safety($p185, $p186);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 169, 26} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p184, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 172, 22} true;
  $p187 := $bitcast.ref.ref($p154);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 172, 22} true;
  $p188 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 172, 22} true;
  call __SMACK_check_memory_safety($p187, $p188);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 172, 22} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p154, $p177);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 173, 30} true;
  assume {:verifier.code 0} true;
  $p189 := $add.ref($add.ref($p177, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 148, 13} true;
  assume {:verifier.code 0} true;
  $p154 := $p189;
  goto $bb44;
$bb59:
  assume ($i201 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 205, 29} true;
  assume {:verifier.code 0} true;
  $p202 := $add.ref($add.ref($p121, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 205, 29} true;
  $p203 := $bitcast.ref.ref($p202);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 205, 29} true;
  $p204 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 205, 29} true;
  call __SMACK_check_memory_safety($p203, $p204);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 205, 29} true;
  assume {:verifier.code 0} true;
  $p205 := $load.ref($M.0, $p202);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 205, 16} true;
  assume {:verifier.code 0} true;
  $p206 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 205, 21} true;
  $p207 := $bitcast.ref.ref($p206);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 205, 21} true;
  $p208 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 205, 21} true;
  call __SMACK_check_memory_safety($p207, $p208);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 205, 21} true;
  assume {:verifier.code 0} true;
  $M.7 := $store.ref($M.7, $p206, $p205);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 205, 11} true;
  assume {:verifier.code 0} true;
  goto $bb61;
$bb60:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 204, 13} true;
  ...
  goto $bb61;
$bb61:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 213, 19} true;
  assume {:verifier.code 0} true;
  $p209 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 213, 19} true;
  $p210 := $bitcast.ref.ref($p209);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 213, 19} true;
  $p211 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 213, 19} true;
  call __SMACK_check_memory_safety($p210, $p211);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 213, 19} true;
  assume {:verifier.code 0} true;
  $p212 := $load.ref($M.6, $p209);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 213, 14} true;
  assume {:verifier.code 0} true;
  $i213 := $ne.ref($p212, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 213, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i213} true;
  goto $bb62, $bb63;
$bb62:
  assume ($i213 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 216, 39} true;
  assume {:verifier.code 0} true;
  $p215 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 216, 39} true;
  $p216 := $bitcast.ref.ref($p215);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 216, 39} true;
  $p217 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 216, 39} true;
  call __SMACK_check_memory_safety($p216, $p217);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 216, 39} true;
  assume {:verifier.code 0} true;
  $p218 := $load.ref($M.7, $p215);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 37} true;
  assume {:verifier.code 0} true;
  $p219 := $add.ref($add.ref($p218, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 37} true;
  $p220 := $bitcast.ref.ref($p219);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 37} true;
  $p221 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 37} true;
  call __SMACK_check_memory_safety($p220, $p221);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 37} true;
  assume {:verifier.code 0} true;
  $p222 := $load.ref($M.0, $p219);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 21} true;
  assume {:verifier.code 0} true;
  $p223 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 26} true;
  $p224 := $bitcast.ref.ref($p223);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 26} true;
  $p225 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 26} true;
  call __SMACK_check_memory_safety($p224, $p225);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 26} true;
  assume {:verifier.code 0} true;
  $M.7 := $store.ref($M.7, $p223, $p222);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 26} true;
  assume {:verifier.code 0} true;
  $i226 := $ne.ref($p222, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 217, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i226} true;
  goto $bb65, $bb66;
$bb63:
  assume !(($i213 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 214, 11} true;
  assume {:verifier.code 0} true;
  $p214 := $0.ref;
  goto $bb64;
$bb64:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 228, 7} true;
  assume {:verifier.code 0} true;
  $p250 := $p214;
  goto $bb71;
$bb65:
  assume ($i226 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 218, 13} true;
  assume {:verifier.code 0} true;
  goto $bb67;
$bb66:
  assume !(($i226 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 35} true;
  assume {:verifier.code 0} true;
  $p227 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 35} true;
  $p228 := $bitcast.ref.ref($p227);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 35} true;
  $p229 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 35} true;
  call __SMACK_check_memory_safety($p228, $p229);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 35} true;
  assume {:verifier.code 0} true;
  $p230 := $load.ref($M.6, $p227);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 41} true;
  assume {:verifier.code 0} true;
  $p231 := $add.ref($add.ref($p230, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 41} true;
  $p232 := $bitcast.ref.ref($p231);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 41} true;
  $p233 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 41} true;
  call __SMACK_check_memory_safety($p232, $p233);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 41} true;
  assume {:verifier.code 0} true;
  $p234 := $load.ref($M.2, $p231);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 23} true;
  assume {:verifier.code 0} true;
  $p235 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 28} true;
  $p236 := $bitcast.ref.ref($p235);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 28} true;
  $p237 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 28} true;
  call __SMACK_check_memory_safety($p236, $p237);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 28} true;
  assume {:verifier.code 0} true;
  $M.6 := $store.ref($M.6, $p235, $p234);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 28} true;
  assume {:verifier.code 0} true;
  $i238 := $ne.ref($p234, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 17} true;
  assume {:verifier.code 0} true;
...
$bb68:
  assume ($i238 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 32} true;
  assume {:verifier.code 0} true;
  $p239 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 32} true;
  $p240 := $bitcast.ref.ref($p239);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 32} true;
  $p241 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 32} true;
  call __SMACK_check_memory_safety($p240, $p241);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 32} true;
  assume {:verifier.code 0} true;
  $p242 := $load.ref($M.6, $p239);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 38} true;
  assume {:verifier.code 0} true;
  $p243 := $add.ref($add.ref($p242, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 38} true;
  $p244 := $bitcast.ref.ref($p243);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 38} true;
  $p245 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 38} true;
  call __SMACK_check_memory_safety($p244, $p245);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 38} true;
  assume {:verifier.code 0} true;
  $p246 := $load.ref($M.0, $p243);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 20} true;
  assume {:verifier.code 0} true;
  $p247 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 25} true;
  $p248 := $bitcast.ref.ref($p247);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 25} true;
  $p249 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 25} true;
  call __SMACK_check_memory_safety($p248, $p249);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 25} true;
  assume {:verifier.code 0} true;
  $M.7 := $store.ref($M.7, $p247, $p246);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 221, 15} true;
  assume {:verifier.code 0} true;
  goto $bb70;
$bb69:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 220, 17} true;
...
$bb72:
  assume ($i251 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 234, 21} true;
  assume {:verifier.code 0} true;
  $p252 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 234, 21} true;
  $p253 := $bitcast.ref.ref($p252);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 234, 21} true;
  $p254 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 234, 21} true;
  call __SMACK_check_memory_safety($p253, $p254);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 234, 21} true;
  assume {:verifier.code 0} true;
  $p255 := $load.ref($M.6, $p252);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 234, 16} true;
  assume {:verifier.code 0} true;
  $i256 := $ne.ref($p255, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 234, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i256} true;
  goto $bb74, $bb75;
$bb73:
  assume !(($i251 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 257, 7} true;
  assume {:verifier.code 0} true;
  $p293 := $p121;
  goto $bb83;
$bb74:
  assume ($i256 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 237, 41} true;
  assume {:verifier.code 0} true;
  $p258 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 237, 41} true;
  $p259 := $bitcast.ref.ref($p258);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 237, 41} true;
  $p260 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 237, 41} true;
  call __SMACK_check_memory_safety($p259, $p260);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 237, 41} true;
  assume {:verifier.code 0} true;
  $p261 := $load.ref($M.7, $p258);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 39} true;
  assume {:verifier.code 0} true;
  $p262 := $add.ref($add.ref($p261, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 39} true;
  $p263 := $bitcast.ref.ref($p262);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 39} true;
  $p264 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 39} true;
  call __SMACK_check_memory_safety($p263, $p264);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 39} true;
  assume {:verifier.code 0} true;
  $p265 := $load.ref($M.0, $p262);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 23} true;
  assume {:verifier.code 0} true;
  $p266 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 28} true;
  $p267 := $bitcast.ref.ref($p266);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 28} true;
  $p268 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 28} true;
  call __SMACK_check_memory_safety($p267, $p268);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 28} true;
  assume {:verifier.code 0} true;
  $M.7 := $store.ref($M.7, $p266, $p265);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 28} true;
  assume {:verifier.code 0} true;
  $i269 := $ne.ref($p265, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 238, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i269} true;
  goto $bb77, $bb78;
$bb75:
  assume !(($i256 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 235, 13} true;
  assume {:verifier.code 0} true;
  $p257 := $0.ref;
  goto $bb76;
$bb76:
...
$bb77:
  assume ($i269 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 239, 15} true;
  assume {:verifier.code 0} true;
  goto $bb79;
$bb78:
  assume !(($i269 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 37} true;
  assume {:verifier.code 0} true;
  $p270 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 37} true;
  $p271 := $bitcast.ref.ref($p270);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 37} true;
  $p272 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 37} true;
  call __SMACK_check_memory_safety($p271, $p272);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 37} true;
  assume {:verifier.code 0} true;
  $p273 := $load.ref($M.6, $p270);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 43} true;
  assume {:verifier.code 0} true;
  $p274 := $add.ref($add.ref($p273, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 43} true;
  $p275 := $bitcast.ref.ref($p274);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 43} true;
  $p276 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 43} true;
  call __SMACK_check_memory_safety($p275, $p276);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 43} true;
  assume {:verifier.code 0} true;
  $p277 := $load.ref($M.2, $p274);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 25} true;
  assume {:verifier.code 0} true;
  $p278 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 30} true;
  $p279 := $bitcast.ref.ref($p278);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 30} true;
  $p280 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 30} true;
  call __SMACK_check_memory_safety($p279, $p280);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 30} true;
  assume {:verifier.code 0} true;
  $M.6 := $store.ref($M.6, $p278, $p277);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 30} true;
  assume {:verifier.code 0} true;
  $i281 := $ne.ref($p277, $0.ref);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 19} true;
  assume {:verifier.code 0} true;
...
$bb80:
  assume ($i281 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 34} true;
  assume {:verifier.code 0} true;
  $p282 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 34} true;
  $p283 := $bitcast.ref.ref($p282);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 34} true;
  $p284 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 34} true;
  call __SMACK_check_memory_safety($p283, $p284);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 34} true;
  assume {:verifier.code 0} true;
  $p285 := $load.ref($M.6, $p282);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 40} true;
  assume {:verifier.code 0} true;
  $p286 := $add.ref($add.ref($p285, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 40} true;
  $p287 := $bitcast.ref.ref($p286);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 40} true;
  $p288 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 40} true;
  call __SMACK_check_memory_safety($p287, $p288);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 40} true;
  assume {:verifier.code 0} true;
  $p289 := $load.ref($M.0, $p286);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 22} true;
  assume {:verifier.code 0} true;
  $p290 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 27} true;
  $p291 := $bitcast.ref.ref($p290);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 27} true;
  $p292 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 27} true;
  call __SMACK_check_memory_safety($p291, $p292);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 27} true;
  assume {:verifier.code 0} true;
  $M.7 := $store.ref($M.7, $p290, $p289);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 242, 17} true;
  assume {:verifier.code 0} true;
  goto $bb82;
$bb81:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 241, 19} true;
...
$bb84:
  assume ($i294 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 258, 35} true;
  assume {:verifier.code 0} true;
  $p295 := $add.ref($add.ref($p293, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 258, 35} true;
  $p296 := $bitcast.ref.ref($p295);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 258, 35} true;
  $p297 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 258, 35} true;
  call __SMACK_check_memory_safety($p296, $p297);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 258, 35} true;
  assume {:verifier.code 0} true;
  $p298 := $load.ref($M.2, $p295);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 260, 35} true;
  assume {:verifier.code 0} true;
  $p299 := $add.ref($add.ref($p293, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 260, 35} true;
  $p300 := $bitcast.ref.ref($p299);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 260, 35} true;
  $p301 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 260, 35} true;
  call __SMACK_check_memory_safety($p300, $p301);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 260, 35} true;
  assume {:verifier.code 0} true;
  $p302 := $load.ref($M.0, $p299);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 261, 9} true;
  assume {:verifier.code 0} true;
  $p303 := $p302;
  goto $bb86;
$bb85:
  assume !(($i294 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 274, 5} true;
...
$bb87:
  assume ($i304 == 1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 262, 40} true;
  assume {:verifier.code 0} true;
  $p305 := $add.ref($add.ref($p303, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 262, 40} true;
  $p306 := $bitcast.ref.ref($p305);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 262, 40} true;
  $p307 := $bitcast.ref.ref($i2p.i64.ref(8));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 262, 40} true;
  call __SMACK_check_memory_safety($p306, $p307);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 262, 40} true;
  assume {:verifier.code 0} true;
  $p308 := $load.ref($M.0, $p305);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 263, 18} true;
  assume {:verifier.code 0} true;
  $p309 := $bitcast.ref.ref($p303);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 263, 13} true;
  assume {:verifier.code 0} true;
  call free_($p309);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 261, 9} true;
  assume {:verifier.code 0} true;
...
$bb88:
  assume !(($i304 == 1));
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 267, 14} true;
  assume {:verifier.code 0} true;
  $p310 := $bitcast.ref.ref($p293);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 267, 9} true;
  assume {:verifier.code 0} true;
  call free_($p310);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-0521.c", 257, 7} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 3102));
procedure {:inline 3} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const malloc: ref;
axiom (malloc == $sub.ref(0, 4134));
procedure {:inline 3} malloc($i0: i64)
  returns ($r: ref)
{
  call $r := $malloc($i0);
}
const free_: ref;
axiom (free_ == $sub.ref(0, 5166));
procedure {:inline 3} free_($p0: ref)
{
  call $free($p0);
}
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 6198));
procedure {:inline 3} __SMACK_code.ref($p0: ref);
procedure {:inline 3} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 7230));
procedure {:inline 3} __VERIFIER_assume($i0: i32)
{
$bb0:
...
axiom (__SMACK_dummy == $sub.ref(0, 8262));
procedure {:inline 3} __SMACK_dummy($i0: i32)
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1604, 29} true;
  assume {:verifier.code 1} true;
...
axiom (__SMACK_and32 == $sub.ref(0, 9294));
procedure {:inline 3} __SMACK_and32($i0: i32, $i1: i32)
  returns ($r: i32)
{
  var $i2: i32;
  var $i3: i1;
...
axiom (__SMACK_and64 == $sub.ref(0, 10326));
procedure {:inline 3} __SMACK_and64($i0: i64, $i1: i64)
  returns ($r: i64)
{
  var $i2: i32;
  var $i3: i32;
...
axiom (__SMACK_and16 == $sub.ref(0, 11358));
procedure {:inline 3} __SMACK_and16($i0: i16, $i1: i16)
  returns ($r: i16)
{
  var $i2: i32;
  var $i3: i32;
...
axiom (__SMACK_and8 == $sub.ref(0, 12390));
procedure {:inline 3} __SMACK_and8($i0: i8, $i1: i8)
  returns ($r: i8)
{
  var $i2: i32;
  var $i3: i32;
...
axiom (__SMACK_or32 == $sub.ref(0, 13422));
procedure {:inline 3} __SMACK_or32($i0: i32, $i1: i32)
  returns ($r: i32)
{
  var $i2: i32;
  var $i3: i1;
...
axiom (__SMACK_or64 == $sub.ref(0, 14454));
procedure {:inline 3} __SMACK_or64($i0: i64, $i1: i64)
  returns ($r: i64)
{
  var $i2: i32;
  var $i3: i32;
...
axiom (__SMACK_or16 == $sub.ref(0, 15486));
procedure {:inline 3} __SMACK_or16($i0: i16, $i1: i16)
  returns ($r: i16)
{
  var $i2: i32;
  var $i3: i32;
...
axiom (__SMACK_or8 == $sub.ref(0, 16518));
procedure {:inline 3} __SMACK_or8($i0: i8, $i1: i8)
  returns ($r: i8)
{
  var $i2: i32;
  var $i3: i32;
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17550));
procedure {:inline 3} __SMACK_check_overflow($i0: i32)
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1604, 29} true;
  assume {:verifier.code 1} true;
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 18582));
procedure {:inline 3} __VERIFIER_nondet_int()
  returns ($r: i32)
{
  var $i0: i32;
  var $i1: i1;
...
axiom (__SMACK_nondet_int == $sub.ref(0, 19614));
procedure {:inline 3} __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 20646));
type $mop;
procedure {:inline 3} boogie_si_record_mop(m: $mop);
const $MOP: $mop;
var $exn: bool;
var $exnv: int;
procedure {:inline 3} corral_atomic_begin();
procedure {:inline 3} corral_atomic_end();
procedure {:inline 3} $alloc(n: ref) returns (p: ref)
{
...
procedure {:inline 3} $malloc(n: ref) returns (p: ref)
...
procedure {:inline 3} $galloc(base_addr: ref, size: ref)
{
...
axiom (__SMACK_top_decl == $sub.ref(0, 21678));
procedure {:inline 3} __SMACK_top_decl.ref($p0: ref);
const __SMACK_check_memory_safety: ref;
axiom (__SMACK_check_memory_safety == $sub.ref(0, 22710));
procedure {:inline 3} __SMACK_check_memory_safety($p0: ref, $p1: ref);
const __SMACK_check_memory_leak: ref;
axiom (__SMACK_check_memory_leak == $sub.ref(0, 23742));
procedure {:inline 3} __SMACK_check_memory_leak()
{
$bb0:
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 24774));
procedure {:inline 3} __SMACK_init_func_memory_model()
{
$bb0:
...
const __SMACK_my_memory_check: ref;
axiom (__SMACK_my_memory_check == $sub.ref(0, 25806));
procedure {:inline 3} __SMACK_my_memory_check()
{
  var $myvariable:int;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1894, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1894, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1895, 3} true;
  assume {:verifier.code 1} true;
  $myvariable := 1;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1896, 3} true;
  assume {:verifier.code 1} true;
  assert $myvariable == 0;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1897, 3} true;
  assume {:verifier.code 1} true;
  /*This is my check*/
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1898, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __SMACK_decl: ref;
axiom (__SMACK_decl == $sub.ref(0, 26838));
procedure {:inline 3} __SMACK_decl.ref($p0: ref);
const __SMACK_whatIsThis: ref;
axiom (__SMACK_whatIsThis == $sub.ref(0, 27870));
procedure {:inline 3} __SMACK_whatIsThis()
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/TestIncl.c", 4, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "/usr/local/share/smack/lib/TestIncl.c", 4, 5} true;
  assume {:verifier.code 0} true;
  assert false;
  assume {:sourceloc "/usr/local/share/smack/lib/TestIncl.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __WHAT_code: ref;
axiom (__WHAT_code == $sub.ref(0, 28902));
procedure {:inline 3} __WHAT_code.ref($p0: ref);
const abort: ref;
axiom (abort == $sub.ref(0, 29934));
procedure {:inline 3} abort()
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 19, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 19, 3} true;
  assume {:verifier.code 1} true;
  assert {:valid_memtrack} $allocatedCounter == 0;
...
axiom (llvm.dbg.value == $sub.ref(0, 30966));
procedure {:inline 3} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 31998));
procedure {:inline 3} __SMACK_static_init()
{
$bb0:
  $exn := false;
  return;
}
procedure {:inline 3} boogie_si_record_i16(x: i16);
procedure {:inline 3} boogie_si_record_i32(x: i32);
procedure {:inline 3} boogie_si_record_i64(x: i64);
procedure {:inline 3} boogie_si_record_i8(x: i8);
procedure {:inline 3} boogie_si_record_ref(x: ref);
procedure {:inline 3} $initialize()
{
