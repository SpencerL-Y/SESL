...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/test-memleak_nexttime.c -ll ../testcases/svcomp/memsafety/test-memleak_nexttime.c.ll --bpl ../testcases/svcomp/memsafety/test-memleak_nexttime.c.bpl --verifier boogie --check memleak memory-safety --unroll 3
...
procedure {:inline 3} foo()
{
  ...
  var $p9: ref;
$bb0:
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 15, 20} true;
  ...
  assume {:verifier.code 0} true;
  call $p1 := malloc(10);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 15, 13} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 15, 9} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 16, 4} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p0);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 16, 4} true;
  $p6 := $bitcast.ref.ref(a);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 16, 4} true;
  $p7 := $i2p.i64.ref(8);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 16, 4} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 16, 4} true;
  assume {:verifier.code 0} true;
  call $M.0 := $memcpy.i8($M.0, $M.0, a, $p5, 8, false);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 17, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 4134));
...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0, 6198));
procedure {:inline 3} llvm.memcpy.p0i8.p0i8.i64($p0: ref, $p1: ref, $i2: i64, $i3: i1);
const main: ref;
axiom (main == $sub.ref(0, 7230));
...
$bb0:
  call $initialize();
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 21, 4} true;
  assume {:verifier.code 0} true;
  ...
  call foo();
  assume true;
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 23, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 24, 9} true;
  ...
  assume {:verifier.code 0} true;
  $p8 := $load.ref($M.1, $p0);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 24, 4} true;
  assume {:verifier.code 0} true;
  call free_($p8);
  assume {:sourceloc "../testcases/svcomp/memsafety/test-memleak_nexttime.c", 25, 1} true;
...
axiom (__SMACK_dummy == $sub.ref(0, 11358));
...
axiom (__SMACK_and32 == $sub.ref(0, 12390));
...
axiom (__SMACK_and64 == $sub.ref(0, 13422));
...
axiom (__SMACK_and16 == $sub.ref(0, 14454));
...
axiom (__SMACK_and8 == $sub.ref(0, 15486));
...
axiom (__SMACK_or32 == $sub.ref(0, 16518));
...
axiom (__SMACK_or64 == $sub.ref(0, 17550));
...
axiom (__SMACK_or16 == $sub.ref(0, 18582));
...
axiom (__SMACK_or8 == $sub.ref(0, 19614));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 20646));
