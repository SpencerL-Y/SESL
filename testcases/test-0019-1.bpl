...
// via /usr/local/bin/smack ../testcases/svcomp/memsafety/test-0019-1.c --bpl ../testcases/test-0019-1.bpl --verifier boogie
...
procedure {:inline 1} alloc_data($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
...
procedure {:inline 1} free_data($p0: ref, $p1: ref)
{
  var $p2: ref;
  var $p3: ref;
  var $p4: ref;
