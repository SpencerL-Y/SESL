...
// via /usr/local/bin/smack ../testcases/test1.c -ll ../testcases/test1_final.ll --bpl ../testcases/test1.bpl --verifier boogie --check memory-safety
...
// Global allocations
procedure {:inline 1} $global_allocations()
{
...
$bb0:
  call $initialize();
  assume {:sourceloc "../testcases/test1.c", 10, 16} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "../testcases/test1.c", 10, 16} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "../testcases/test1.c", 10, 9} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "../testcases/test1.c", 11, 8} true;
  ...
  assume {:sourceloc "../testcases/test1.c", 12, 10} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "../testcases/test1.c", 12, 5} true;
  assume {:verifier.code 0} true;
  call free_($p4);
  assume {:sourceloc "../testcases/test1.c", 13, 8} true;
  ...
  assume {:sourceloc "../testcases/test1.c", 14, 1} true;
...
procedure {:inline 1} $galloc(base_addr: ref, size: ref)
{
...
axiom (__SMACK_check_memory_safety == $sub.ref(0, 18576));
procedure {:inline 1} __SMACK_check_memory_safety($p0: ref, $p1: ref);
const __SMACK_check_memory_leak: ref;
axiom (__SMACK_check_memory_leak == $sub.ref(0, 19608));
procedure {:inline 1} __SMACK_check_memory_leak()
{
$bb0:
