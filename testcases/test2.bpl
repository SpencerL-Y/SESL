...
// via /usr/local/bin/smack ../testcases/test2.c --bpl ../testcases/test2.bpl --verifier boogie
  ...
  returns ($r: ref)
{
  ...
  var $p3: ref;
$bb0:
  assume {:sourceloc "../testcases/test2.c", 19, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "create:arg:limit"} boogie_si_record_i32($i0);
  assume {:sourceloc "../testcases/test2.c", 19, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $sle.i32($i0, 0);
  assume {:sourceloc "../testcases/test2.c", 19, 18} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "../testcases/test2.c", 19, 40} true;
  assume {:verifier.code 0} true;
  $p3 := $0.ref;
  goto $bb6;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "../testcases/test2.c", 19, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i0, 1000);
  assume {:sourceloc "../testcases/test2.c", 19, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i2 == 1));
  assume {:sourceloc "../testcases/test2.c", 20, 29} true;
  assume {:verifier.code 0} true;
  call $p4 := malloc(8);
  assume {:sourceloc "../testcases/test2.c", 20, 18} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p4);
  assume {:sourceloc "../testcases/test2.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p5, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/test2.c", 21, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p6, 0);
  assume {:sourceloc "../testcases/test2.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p5, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "../testcases/test2.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p7, $i0);
  assume {:sourceloc "../testcases/test2.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $p3 := $p4;
  goto $bb6;
$bb6:
  assume {:sourceloc "../testcases/test2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../testcases/test2.c", 24, 1} true;
  assume {:verifier.code 0} true;
  $r := $p3;
  $exn := false;
  return;
...
const get_balance: ref;
axiom (get_balance == $sub.ref(0, 3096));
procedure {:inline 1} get_balance($p0: ref)
  returns ($r: i32)
{
  var $p1: ref;
  var $i2: i32;
$bb0:
  assume {:sourceloc "../testcases/test2.c", 28, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../testcases/test2.c", 28, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "../testcases/test2.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
const deposit: ref;
axiom (deposit == $sub.ref(0, 4128));
procedure {:inline 1} deposit($p0: ref, $i1: i32)
  returns ($r: i32)
{
  var $i2: i1;
  var $p4: ref;
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "../testcases/test2.c", 33, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "deposit:arg:n"} boogie_si_record_i32($i1);
  assume {:sourceloc "../testcases/test2.c", 33, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $sle.i32($i1, 0);
  assume {:sourceloc "../testcases/test2.c", 33, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "../testcases/test2.c", 33, 15} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "../testcases/test2.c", 34, 12} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/test2.c", 34, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, $p4);
  assume {:sourceloc "../testcases/test2.c", 34, 27} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "../testcases/test2.c", 34, 27} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.1, $p6);
  assume {:sourceloc "../testcases/test2.c", 34, 33} true;
  assume {:verifier.code 0} true;
  $i8 := $sub.i32($i7, $i1);
  assume {:sourceloc "../testcases/test2.c", 34, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $sgt.i32($i5, $i8);
  assume {:sourceloc "../testcases/test2.c", 34, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "../testcases/test2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../testcases/test2.c", 39, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume ($i9 == 1);
  assume {:sourceloc "../testcases/test2.c", 35, 5} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb5:
  assume !(($i9 == 1));
  assume {:sourceloc "../testcases/test2.c", 37, 23} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/test2.c", 37, 23} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.0, $p10);
  assume {:sourceloc "../testcases/test2.c", 37, 31} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i11, $i1);
  assume {:sourceloc "../testcases/test2.c", 37, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/test2.c", 37, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p13, $i12);
  assume {:sourceloc "../testcases/test2.c", 38, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 1;
  goto $bb3;
}
const withdraw: ref;
axiom (withdraw == $sub.ref(0, 5160));
procedure {:inline 1} withdraw($p0: ref, $i1: i32)
  returns ($r: i32)
{
  var $i2: i1;
  var $p4: ref;
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "../testcases/test2.c", 43, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "withdraw:arg:n"} boogie_si_record_i32($i1);
  assume {:sourceloc "../testcases/test2.c", 43, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $sle.i32($i1, 0);
  assume {:sourceloc "../testcases/test2.c", 43, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "../testcases/test2.c", 43, 15} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "../testcases/test2.c", 44, 12} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/test2.c", 44, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, $p4);
  assume {:sourceloc "../testcases/test2.c", 44, 20} true;
  assume {:verifier.code 0} true;
  $i6 := $sge.i32($i5, $i1);
  assume {:sourceloc "../testcases/test2.c", 44, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "../testcases/test2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../testcases/test2.c", 49, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "../testcases/test2.c", 45, 25} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/test2.c", 45, 25} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p7);
  assume {:sourceloc "../testcases/test2.c", 45, 33} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i32($i8, $i1);
  assume {:sourceloc "../testcases/test2.c", 45, 10} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "../testcases/test2.c", 45, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p10, $i9);
  assume {:sourceloc "../testcases/test2.c", 46, 5} true;
  assume {:verifier.code 0} true;
  $i3 := 1;
  goto $bb3;
$bb5:
  assume !(($i6 == 1));
  assume {:sourceloc "../testcases/test2.c", 48, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
}
const test_account: ref;
axiom (test_account == $sub.ref(0, 6192));
procedure {:inline 1} test_account($i0: i32, $i1: i32, $i2: i32)
{
  var $p3: ref;
  var $i4: i1;
  var $i5: i1;
  ...
  var $p28: ref;
$bb0:
  assume {:sourceloc "../testcases/test2.c", 56, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "test_account:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "test_account:arg:y"} boogie_si_record_i32($i1);
  call {:cexpr "test_account:arg:z"} boogie_si_record_i32($i2);
  assume {:sourceloc "../testcases/test2.c", 56, 9} true;
  assume {:verifier.code 0} true;
  call $p3 := create($i0);
  assume {:sourceloc "../testcases/test2.c", 57, 8} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.ref($p3, $0.ref);
  assume {:sourceloc "../testcases/test2.c", 57, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "../testcases/test2.c", 61, 10} true;
  assume {:verifier.code 0} true;
  call $i7 := deposit($p3, $i1);
  assume {:sourceloc "../testcases/test2.c", 61, 7} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32(0, $i7);
  call {:cexpr "ops"} boogie_si_record_i32($i8);
  assume {:sourceloc "../testcases/test2.c", 62, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "../testcases/test2.c", 58, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "../testcases/test2.c", 58, 5} true;
...
$bb8:
  ...
  goto $bb5;
$bb9:
  assume {:sourceloc "../testcases/test2.c", 59, 5} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "../testcases/test2.c", 70, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb11:
...
$bb12:
  ...
  assume {:sourceloc "../testcases/test2.c", 62, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := get_balance($p3);
  assume {:sourceloc "../testcases/test2.c", 62, 3} true;
  assume {:verifier.code 0} true;
  $i12 := $sle.i32($i11, 1000);
  assume {:sourceloc "../testcases/test2.c", 62, 3} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb14;
$bb18:
  assume {:sourceloc "../testcases/test2.c", 63, 10} true;
  assume {:verifier.code 0} true;
  call $i13 := deposit($p3, $i2);
  assume {:sourceloc "../testcases/test2.c", 63, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i8, $i13);
  call {:cexpr "ops"} boogie_si_record_i32($i14);
  assume {:sourceloc "../testcases/test2.c", 64, 3} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb19:
  assume {:sourceloc "../testcases/test2.c", 64, 3} true;
  assume {:verifier.code 0} true;
  call $i15 := get_balance($p3);
  assume {:sourceloc "../testcases/test2.c", 64, 3} true;
  assume {:verifier.code 0} true;
  $i16 := $sge.i32($i15, 0);
  assume {:sourceloc "../testcases/test2.c", 64, 3} true;
...
$bb20:
  ...
  assume {:sourceloc "../testcases/test2.c", 64, 3} true;
  assume {:verifier.code 0} true;
  call $i17 := get_balance($p3);
  assume {:sourceloc "../testcases/test2.c", 64, 3} true;
  assume {:verifier.code 0} true;
  $i18 := $sle.i32($i17, 1000);
  assume {:sourceloc "../testcases/test2.c", 64, 3} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  goto $bb22;
$bb26:
  assume {:sourceloc "../testcases/test2.c", 65, 10} true;
  assume {:verifier.code 0} true;
  call $i19 := withdraw($p3, $i2);
  assume {:sourceloc "../testcases/test2.c", 65, 7} true;
  assume {:verifier.code 0} true;
  $i20 := $add.i32($i14, $i19);
  call {:cexpr "ops"} boogie_si_record_i32($i20);
  assume {:sourceloc "../testcases/test2.c", 66, 3} true;
  assume {:verifier.code 0} true;
  goto $bb27;
$bb27:
  assume {:sourceloc "../testcases/test2.c", 66, 3} true;
  assume {:verifier.code 0} true;
  call $i21 := get_balance($p3);
  assume {:sourceloc "../testcases/test2.c", 66, 3} true;
  assume {:verifier.code 0} true;
  $i22 := $sge.i32($i21, 0);
  assume {:sourceloc "../testcases/test2.c", 66, 3} true;
...
$bb28:
  ...
  assume {:sourceloc "../testcases/test2.c", 66, 3} true;
  assume {:verifier.code 0} true;
  call $i23 := get_balance($p3);
  assume {:sourceloc "../testcases/test2.c", 66, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $sle.i32($i23, 1000);
  assume {:sourceloc "../testcases/test2.c", 66, 3} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  goto $bb30;
$bb34:
  assume {:sourceloc "../testcases/test2.c", 67, 3} true;
  assume {:verifier.code 0} true;
  goto $bb35;
$bb35:
  assume {:sourceloc "../testcases/test2.c", 67, 3} true;
...
$bb40:
  ...
  goto $bb37;
$bb41:
  assume {:sourceloc "../testcases/test2.c", 68, 8} true;
  assume {:verifier.code 0} true;
  $p28 := $bitcast.ref.ref($p3);
  assume {:sourceloc "../testcases/test2.c", 68, 3} true;
  assume {:verifier.code 0} true;
  call free_($p28);
  assume {:sourceloc "../testcases/test2.c", 69, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
}
const free_: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "../testcases/test2.c", 73, 11} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "../testcases/test2.c", 74, 11} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "../testcases/test2.c", 75, 11} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "../testcases/test2.c", 78, 3} true;
  assume {:verifier.code 0} true;
  call test_account($i0, $i1, $i2);
  assume {:sourceloc "../testcases/test2.c", 79, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 22704));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 23736));
